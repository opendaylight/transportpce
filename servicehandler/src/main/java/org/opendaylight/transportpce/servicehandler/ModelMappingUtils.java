...
public final class ModelMappingUtils {
    ...
    public static OtnServicePathInput createOtnServicePathInput(ServiceInput input,
        ...
        List<Nodes> nodeaList = getNodesListAToZ(pathDescription.getAToZDirection().getAToZ().iterator());
        List<Nodes> nodezList = getNodesListZtoA(pathDescription.getZToADirection().getZToA().iterator());
        nodesList.addAll(nodeaList);
        nodesList.addAll(nodezList);
        ...
        return new OtnServicePathInputBuilder()
            ...
            .setServiceType(input.getServiceAEnd().getServiceFormat().toString())
            .setTribSlot((short) 1)
