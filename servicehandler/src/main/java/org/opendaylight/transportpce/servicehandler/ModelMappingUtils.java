            ...
            if (srcID == null) {
                ...
                desID = values.getTpID();
                    ...
                    org.opendaylight.yang.gen.v1.http.org.transportpce.common.types.rev200128.otn.renderer.input.NodesBuilder
                        nb = new  org.opendaylight.yang.gen.v1.http.org.transportpce.common.types.rev200128.otn.renderer.input.NodesBuilder().withKey(new NodesKey(values.getNodeID())).setNetworkTp(desID).setClientTp(srcID);
                list.add(nb.build());
                srcID = null;
                desID = null;
            } else {
