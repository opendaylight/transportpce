...
// import org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev190531.ServiceNotification;
// import org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev190531.ServiceNotificationBuilder;
...
public class NetworkModelListenerImp implements TransportpceNetworkmodelListener {
    ...
    public void onTopologyUpdateResult(TopologyUpdateResult notification) {
                    ...
                    if (serviceListOptional.isPresent()) {
                        ...
                        if (serviceList.getServices() != null) {
                            for (Services services:serviceList.getServices()) {
                                ...
                                // TODO: change lifecycle of service.
                                //  If inService -> deployed. If outOfService -> deploy-failed
                                // TODO: create service notification
                                // TODO: service back up?? There is a need to check for everything.
                            }
                        }
                    }
                }
        ...
        // TODO:
        //  - Report TAPI.
        // ServiceNotification serviceNotification = new ServiceNotificationBuilder().build();
    }

    private void updateService(Services services, List<PcePathDescriptionElementsAToZ> pceatoz,
                               List<PcePathDescriptionElementsZToA> pceztoa, boolean update) {
            ...
            if (services.getOperationalState().equals(org.opendaylight.yang.gen.v1.http.org.openroadm.common.state
                ...
                this.serviceDataStoreOperations.modifyServiceNM(services.getServiceName(),
                        org.opendaylight.yang.gen.v1.http.org.openroadm.common.state.types
                                .rev181130.State.OutOfService, AdminStates.OutOfService, pceatoz, pceztoa);
            } else {
                ...
                if (backinservice) {
                    ...
                    this.serviceDataStoreOperations.modifyServiceNM(services.getServiceName(),
                            org.opendaylight.yang.gen.v1.http.org.openroadm.common.state.types
                                    .rev181130.State.InService, AdminStates.InService, pceatoz, pceztoa);
                }
            }
        }
    }
