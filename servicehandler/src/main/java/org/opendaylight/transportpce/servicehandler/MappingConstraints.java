...
import org.opendaylight.yang.gen.v1.http.org.openroadm.routing.constraints.rev210924.Constraints;
...
public class MappingConstraints {
    ...
    private void updateConstraintBuilders4Corouting(HardConstraintsBuilder hardConstraintsBuilder,
        ...
        if (tmpCoRouting  !=  null) {
            org.opendaylight.yang.gen.v1.http.org.openroadm.routing.constraints.rev210924.constraints.co.routing.or
                .general.co.routing.CoRouting tmpCoRoutingCoRouting =
        ...
        if (tmpGeneral  !=  null) {
            ...
            if (tmpLatency != null) {
                finalGeneral.setLatency(
                        new LatencyBuilder()
                        .setMaxLatency(Uint32.valueOf(tmpLatency.getMaxLatency().byteValue()))
                        .build());
            }
        }
