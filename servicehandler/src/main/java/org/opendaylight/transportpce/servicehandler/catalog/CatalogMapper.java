...
import org.opendaylight.yang.gen.v1.http.org.openroadm.operational.mode.catalog.rev250530.operational.mode.catalog.OpenroadmOperationalModesBuilder;
...
import org.opendaylight.yang.gen.v1.http.org.openroadm.operational.mode.catalog.rev250530.operational.mode.catalog.SpecificOperationalModesBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.operational.mode.catalog.rev250530.operational.mode.catalog.openroadm.operational.modes.AmplifiersBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.operational.mode.catalog.rev250530.operational.mode.catalog.openroadm.operational.modes.GridParametersBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.operational.mode.catalog.rev250530.operational.mode.catalog.openroadm.operational.modes.RoadmsBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.operational.mode.catalog.rev250530.operational.mode.catalog.openroadm.operational.modes.XpondersPluggablesBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.operational.mode.catalog.rev250530.operational.mode.catalog.openroadm.operational.modes.xponders.pluggables.XponderPluggableOpenroadmOperationalModeBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.operational.mode.catalog.rev250530.operational.mode.catalog.specific.operational.modes.SpecificOperationalModeBuilder;
...
import org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev250530.add.openroadm.operational.modes.to.catalog.input.OperationalModeInfo;
...
public final class CatalogMapper {
    ...
    private static void saveXpondersPlugabbles(OperationalModeInfo modesFromInput) {
        Map<org.opendaylight.yang.gen.v1.http.org.openroadm.operational.mode.catalog.rev250530
     ...
     */
    private static  void saveSpecificOperationalModes(org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev250530
