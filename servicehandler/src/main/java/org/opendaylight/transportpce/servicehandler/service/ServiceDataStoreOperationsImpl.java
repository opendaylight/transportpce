...
import org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129.ServiceList;
import org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129.ServiceListBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129.TempServiceCreateInput;
import org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129.TempServiceList;
import org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129.TempServiceListBuilder;
...
import org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129.service.list.ServicesKey;
...
public class ServiceDataStoreOperationsImpl implements ServiceDataStoreOperations {
    ...
    @Override
    public Optional<org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129.temp.service.list
        .Services> getTempService(String serviceName) {
        try {
            ReadTransaction readTx = this.dataBroker.newReadOnlyTransaction();
            InstanceIdentifier<org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129.temp.service.list
                .Services> iid = InstanceIdentifier.create(TempServiceList.class).child(org.opendaylight.yang.gen.v1
                        .http.org.openroadm.service.rev191129.temp.service.list.Services.class,
                        new org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129.temp.service.list
                            .ServicesKey(serviceName));
            Future<java.util.Optional<org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129
            ...
            try {
                ...
                InstanceIdentifier<org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129.temp.service.list
                    .Services> iid = InstanceIdentifier.create(TempServiceList.class)
                        .child(org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129.temp.service.list
                                .Services.class, new org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129
                ...
                org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129.temp.service.list
                    .Services services = new org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129.temp
    ...
    public OperationResult createTempService(TempServiceCreateInput tempServiceCreateInput) {
        ...
        try {
            InstanceIdentifier<org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129.temp.service.list
                .Services> iid = InstanceIdentifier.create(TempServiceList.class)
                    .child(org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129.temp.service.list
                            .Services.class, new org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev191129.temp
