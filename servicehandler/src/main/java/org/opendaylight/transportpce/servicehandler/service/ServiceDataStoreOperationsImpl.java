...
import org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924.ServiceListBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924.TempServiceCreateInput;
import org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924.TempServiceList;
import org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924.TempServiceListBuilder;
...
public class ServiceDataStoreOperationsImpl implements ServiceDataStoreOperations {
    ...
    @Override
    public Optional<org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924.temp.service.list.Services>
            getTempService(String serviceName) {
        try {
            ReadTransaction readTx = this.dataBroker.newReadOnlyTransaction();
            InstanceIdentifier<org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924.temp.service.list
                .Services> iid = InstanceIdentifier.create(TempServiceList.class).child(org.opendaylight.yang.gen.v1
                        .http.org.openroadm.service.rev210924.temp.service.list.Services.class,
                        new org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924.temp.service.list
                            .ServicesKey(serviceName));
            Future<java.util.Optional<org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924
    ...
    public OperationResult modifyTempService(String serviceName, State operationalState,
        ...
        Optional<org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924.temp.service.list
        ...
        try {
            ...
            InstanceIdentifier<org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924.temp.service.list
                .Services> iid = InstanceIdentifier.create(TempServiceList.class)
                    .child(org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924.temp.service.list
                            .Services.class, new org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924
                                .temp.service.list.ServicesKey(serviceName));
            org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924.temp.service.list.Services services =
                new org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924.temp.service.list.ServicesBuilder(
                    readService.get())
                .setOperationalState(operationalState)
                .setAdministrativeState(administrativeState)
                .build();
    ...
    public OperationResult createTempService(TempServiceCreateInput tempServiceCreateInput) {
        ...
        try {
            InstanceIdentifier<org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924.temp.service.list
                .Services> iid = InstanceIdentifier.create(TempServiceList.class)
                    .child(org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924.temp.service.list
                            .Services.class, new org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev210924.temp
