...
import org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev250530.TempServiceDelete;
...
public class TempServiceDeleteImpl implements TempServiceDelete {
    ...
    public ListenableFuture<RpcResult<TempServiceDeleteOutput>> invoke(TempServiceDeleteInput input) {
        ...
        Optional<org.opendaylight.yang.gen.v1.http.org.openroadm.service.rev250530.temp.service.list.Services>
                serviceOpt =
