        ...
        if (tempService) {
            ...
            if (operationResult.isSuccess()) {
                ...
                sendNbiNotification(nbiNotificationBuilder
                    ...
                    .setAToZ(new org.opendaylight.yang.gen.v1.nbi.notifications.rev230726.notification.process.service
                            .AToZBuilder()
                                ...
                                .build())
                    .setZToA(new org.opendaylight.yang.gen.v1.nbi.notifications.rev230726.notification.process.service
                            .ZToABuilder()
