                ...
                switch (serviceType) {
                    ...
                    case StringConstants.SERVICE_TYPE_100GE_M:
                        updateOtnTopology(notification.getLink(), true, notification.getServiceType(),
                            notification.getAToZDirection().getRate(),
                            notification.getAToZDirection().getTribPortNumber().shortValue(),
                            notification.getAToZDirection().getTribSlotNumber().shortValue());
                        break;
