...
public class RendererListenerImpl implements TransportpceRendererListener, RendererListener {
    ...
    private void onSuccededServiceImplementation(RendererRpcResultSp notification) {
        ...
        if (tempService) {
            ...
            if (operationResult.isSuccess()) {
                ServiceRpcResult serviceRpcResult = sendServiceRpcResultNotification(notification,
    ...
    private ServiceRpcResult sendServiceRpcResultNotification(RendererRpcResultSp notification,
                                                              ServiceNotificationTypes type) {
        try {
