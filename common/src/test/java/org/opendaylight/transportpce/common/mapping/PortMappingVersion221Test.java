...
public class PortMappingVersion221Test {
    ...
    public void createMappingDataTestRdm() throws OpenRoadmInterfaceException {
        ...
        List<ConnectionPorts> connectionPortsList = Arrays.asList(connectionPorts);

        ConnectionPorts connectionPorts2 = getConnectionPorts("c2", "p1");
        List<ConnectionPorts> connectionPortsList2 =  Arrays.asList(connectionPorts2);

        ConnectionPorts connectionPorts3 = getConnectionPorts("c3", "p2");
        ConnectionPorts connectionPorts4 = getConnectionPorts("c3", "p3");
        List<ConnectionPorts> connectionPortsList3 = Arrays.asList(connectionPorts3, connectionPorts4);

        ConnectionPorts connectionPorts5 = getConnectionPorts("c4", "p4");
        ConnectionPorts connectionPorts6 = getConnectionPorts("c4", "p5");
        List<ConnectionPorts> connectionPortsList4 = Arrays.asList(connectionPorts5, connectionPorts6);

        ConnectionPorts connectionPorts55 = getConnectionPorts("c6", "p44");
        ConnectionPorts connectionPorts66 = getConnectionPorts("c6", "p55");
        List<ConnectionPorts> connectionPortsList44 = Arrays.asList(connectionPorts55, connectionPorts66);
        ...
        List<ConnectionPorts> connectionPortsList33 = Arrays.asList(connectionPorts33 , connectionPorts44);
        ...
        Protocols protocols =
            new ProtocolsBuilder().addAugmentation(Protocols1.class,
                    new Protocols1Builder().setLldp(new LldpBuilder().setPortConfig(portConfigList).build()).build())
                .build();
        ...
        InstanceIdentifier<org.opendaylight.yang.gen.v1.http.org.openroadm.device.rev181019
                .org.openroadm.device.container.org.openroadm.device.Degree> deviceIID =
        ...
        InstanceIdentifier<org.opendaylight.yang.gen.v1.http.org.openroadm.device.rev181019
                .org.openroadm.device.container.org.openroadm.device.Degree> deviceIID3 =
            InstanceIdentifier.create(OrgOpenroadmDevice.class)
                .child(org.opendaylight.yang.gen.v1.http.org.openroadm.device.rev181019
                        .org.openroadm.device.container.org.openroadm.device.Degree.class,
                    new DegreeKey(2));
        ...
        InstanceIdentifier<org.opendaylight.yang.gen.v1.http.org.openroadm.device.rev181019
                .org.openroadm.device.container.org.openroadm.device.Degree> deviceIID5 =
            InstanceIdentifier.create(OrgOpenroadmDevice.class)
                .child(org.opendaylight.yang.gen.v1.http.org.openroadm.device.rev181019
                        .org.openroadm.device.container.org.openroadm.device.Degree.class,
                    new DegreeKey(3));
        ...
        assertFalse("create non existed roadm node returns false", portMappingVersion221.createMappingData("node2"));
