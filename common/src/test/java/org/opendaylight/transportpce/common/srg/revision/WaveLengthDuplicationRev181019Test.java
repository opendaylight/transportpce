...
class WaveLengthDuplicationRev181019Test {
    ...
    @Test
    void notNull() {
        WaveLengthDuplicationRev181019 wldRev181019 = new WaveLengthDuplicationRev181019(new HashMap<>());
    ...
    void srgOnePerDegree() {
        ...
        Map<SharedRiskGroupKey, org.opendaylight.yang.gen.v1.http.org.opendaylight.transportpce.portmapping
                .rev260608.shared.risk.group.SharedRiskGroup> srg = wldRev181019.srg();

        assertNotNull(srg);
        assertEquals(1, srg.size());
        org.opendaylight.yang.gen.v1.http.org.opendaylight.transportpce.portmapping
                .rev260608.shared.risk.group.SharedRiskGroup firstItem = srg.values().iterator().next();
