...
public class WaveLengthDuplicationRev200529Test {
    @Test
    void notNull() {
        WaveLengthDuplicationRev200529 wldRev200529 = new WaveLengthDuplicationRev200529(new HashMap<>());
    ...
    void srgOnePerDegree() {
        ...
        Map<SharedRiskGroupKey, org.opendaylight.yang.gen.v1.http.org.opendaylight.transportpce.portmapping
                .rev260608.shared.risk.group.SharedRiskGroup> srg = wldRev200529.srg();
