...
public interface NetworkNode {
    ...
    /**
     * Checks if the SRG is contention-less for a given node.
     *
     * @param networkId the ID of the network
     * @param node the node to check
     * @param storage the storage containing SRG information
     * @return true if contention-less, false otherwise
     */
