...
/**
 * Saves an OpenROADM device rev200529 connection map to storage.
 */
public interface Rev200529 {
     ...
     * @param openRoadm translator used to convert the rev200529 connection map into the TransportPCE model
