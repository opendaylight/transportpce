...
public class SrgRev200529Adapter implements Rev250905 {
    ...
    public SrgRev200529Adapter(Map<SharedRiskGroupKey, SharedRiskGroup> sharedRiskGroupsRev200529) {
    ...
    public static Rev250905 instantiate(List<SharedRiskGroup> sharedRiskGroupsRev200529) {
        if (sharedRiskGroupsRev200529 == null) {
            return new SrgRev181019Adapter(new HashMap<>());
        }

        return new SrgRev200529Adapter(sharedRiskGroupsRev200529.stream()
