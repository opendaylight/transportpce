    ...
    public Map<SharedRiskGroupKey, SharedRiskGroup> srg(
            Map<org.opendaylight.yang.gen.v1.http.org.opendaylight.transportpce.srg
                    ...
                    org.opendaylight.yang.gen.v1.http.org.opendaylight.transportpce.srg
                            .rev250702.network.network.nodes.SharedRiskGroup> sharedRiskGroups
    ) {
        ...
        for (Map.Entry<org.opendaylight.yang.gen.v1.http.org.opendaylight.transportpce.srg
                .rev250702.network.network.nodes.SharedRiskGroupKey,
                org.opendaylight.yang.gen.v1.http.org.opendaylight.transportpce.srg
                        .rev250702.network.network.nodes.SharedRiskGroup> entries : sharedRiskGroups.entrySet()) {

            org.opendaylight.yang.gen.v1.http.org.opendaylight.transportpce.srg
                    .rev250702.network.network.nodes.SharedRiskGroup value = entries.getValue();
