...
import org.opendaylight.yang.gen.v1.http.org.openroadm.device.rev200327.circuit.packs.CircuitPacksBuilder;
...
import org.opendaylight.yang.gen.v1.http.org.openroadm.device.rev200327.interfaces.grp.InterfaceBuilder;
...
import org.opendaylight.yang.gen.v1.http.org.openroadm.maintenance.testsignal.rev200327.maint.testsignal.MaintTestsignalBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.otn.odu.interfaces.rev200327.Interface1;
import org.opendaylight.yang.gen.v1.http.org.openroadm.otn.odu.interfaces.rev200327.Interface1Builder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.otn.odu.interfaces.rev200327.odu.container.OduBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.otn.otu.interfaces.rev200327.otu.container.OtuBuilder;
import org.opendaylight.yangtools.yang.binding.InstanceIdentifier;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class OpenRoadmInterfacesImpl700 {

    private static final Logger LOG = LoggerFactory.getLogger(OpenRoadmInterfacesImpl700.class);

    private final DeviceTransactionManager deviceTransactionManager;

    public OpenRoadmInterfacesImpl700(DeviceTransactionManager deviceTransactionManager) {
    ...
    public void deleteInterface(String nodeId, String interfaceName) throws OpenRoadmInterfaceException {
        LOG.info("deleting interface {} on device700 {}", interfaceName, nodeId);
        ...
        if (intf2DeleteOpt.isPresent()) {
            ...
            if (ifBuilder.getType() == OtnOdu.class) {
                ...
                org.opendaylight.yang.gen.v1.http.org.openroadm.otn.otu.interfaces.rev200327.Interface1Builder
                    otuBuilder =
                    new org.opendaylight.yang.gen.v1.http.org.openroadm.otn.otu.interfaces.rev200327.Interface1Builder(
                        intf2Delete.augmentation(
                            org.opendaylight.yang.gen.v1.http.org.openroadm.otn.otu.interfaces.rev200327.Interface1
                                .class));
                ...
                ifBuilder.addAugmentation(
                    org.opendaylight.yang.gen.v1.http.org.openroadm.otn.otu.interfaces.rev200327.Interface1.class,
                    otuBuilder.build());
            }
