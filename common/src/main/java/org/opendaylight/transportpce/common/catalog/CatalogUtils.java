 ...
 * operational modes. They provide to the PCE, the OLM and and the Renderer, the
...
public class CatalogUtils {
    ...
    /**
     * This methods returns default OperationalModeId for devices that do not expose them.
     *
    ...
    public String getPceTxTspOperationalModeFromServiceType(CatalogConstant.CatalogNodeType catalogNodeType,
        ...
        // To be developed : from rate or Service Type derives an operational mode
    ...
    /**
     * This methods retrieves channel-spacing associated with a Xponder TX.
     *
    ...
    /**
     * This methods retrieves performance parameters associated with a Xponder TX.
     *
     * @param operationalModeId
     *            operational-mode-Id of the Xponder (OR or Specific)
    ...
    public double getPceTxTspParameters(String operationalModeId, String addDropMuxOperationalModeId) {
        ...
        XponderPluggableOpenroadmOperationalMode orTspOM = null;
        SpecificOperationalMode speTspOM = null;
        // InstanceIdentifier<OperationalModeCatalog> omCatalogIid = null;
        // omCatalogIid = InstanceIdentifier.builder(null)
        if (operationalModeId.startsWith("OR")) {
            InstanceIdentifier<XponderPluggableOpenroadmOperationalMode> omCatalogIid = InstanceIdentifier
                .builder(OperationalModeCatalog.class)
                .child(OpenroadmOperationalModes.class)
    ...
    public double getPceRxTspParameters(Decimal64 rate, double calcCd, double calcPmd,
        double calcPdl, double calcOsnrdB) {
        // Map<String, Double> impairments = new HashMap<>();

        // To be developed : from rate or Service Type derives an operational mode and
        // calls
        // method using operational-mode as the input
        return 0.0;
    }

    /**
     * This methods retrieves performance parameters associated with a Xponder RX.
    ...
    public double getPceRxTspParameters(String operationalModeId, double calcCd, double calcPmd,
        ...
        if (operationalModeId.startsWith("OR")) {
            // InstanceIdentifier<XponderPluggableOpenroadmOperationalMode> omCatalogIid =
            // InstanceIdentifier
    ...
    /**
     * This generic methods is called from getPceRxTspParameters to provide the
     ...
     */
    // private generic method called to calculate Penalties associated with CD, PMD
    // and DGD for Xponder
    private double getRxTspPenalty(double calculatedParameter, ImpairmentType impairmentType,
        ...
        if (penalty == null) {
            //means we could find a boundary that is greater than calculatedParameter
    ...
    /**
     * This methods retrieves performance parameters associated with ROADMs and
