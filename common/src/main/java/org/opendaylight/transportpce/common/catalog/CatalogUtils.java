        ...
        switch (catalogNodeType) {
            ...
            case AMP:
                var omCatalogIid3 = InstanceIdentifier
                    ...
                    .child(
                        org.opendaylight.yang.gen.v1.http.org.openroadm.operational.mode.catalog.rev230526.operational
                            .mode.amplifier.parameters.amplifier.OpenroadmOperationalMode.class,
