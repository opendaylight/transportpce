...
/**
 * {@link Rev181019} implementation translating a rev181019 connection map into the
 * TransportPCE connection-map model.
 */
public class TranslateRev181019 implements Rev181019 {
    ...
    public Map<NodeConnectionMapKey, NodeConnectionMap> toTransportPCE(
        ...
        for (Map.Entry<ConnectionMapKey, ConnectionMap> connectionMap : openRoadmConnectionMap.entrySet()) {
            ...
            Map<org.opendaylight.yang.gen.v1.http.org.opendaylight.transportpce.connection.map.rev260819
                    .node.connection.map.group.node.connection.map.DestinationKey,
                org.opendaylight.yang.gen.v1.http.org.opendaylight.transportpce.connection.map.rev260819
