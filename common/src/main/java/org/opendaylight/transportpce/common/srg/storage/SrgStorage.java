...
import org.opendaylight.yang.gen.v1.http.org.opendaylight.transportpce.srg.rev250702.Network;
import org.opendaylight.yang.gen.v1.http.org.opendaylight.transportpce.srg.rev250702.NetworkBuilder;
...
public class SrgStorage implements Storage {
    ...
    public boolean save(String nodeId, Map<SharedRiskGroupKey, SharedRiskGroup> sharedRiskGroupMap) {
        ...
        DataObjectIdentifier<Network> nodesIID = DataObjectIdentifier
    ...
    public Map<SharedRiskGroupKey, SharedRiskGroup> read(NetworkNodesKey nodeId) {
        DataObjectIdentifier.WithKey<NetworkNodes, NetworkNodesKey> nodesIID = DataObjectIdentifier
                .builder(Network.class)
