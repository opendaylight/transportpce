...
public interface PortMapping {
    ...
    /**
     * This method allow retrieving a Mapping object from the mapping list stored in
    ...
    /**
     * This method for a given node's media channel-capabilities returns the object
     * based on portmapping.yang model stored in the MD-SAL data store which is
     * created when the node is connected for the first time. The mapping object
     * basically contains the following attributes of interest:
     *
     ...
     *
     * <p>
     * 3. Supporting OMS interface (if port on ROADM) 4. Supporting OTS interface
     * (if port on ROADM)
     *
     * @param nodeId
     *            Unique Identifier for the node of interest.
