...
/**
 * {@link Rev200529} implementation that translates a rev200529 connection map into the
 * TransportPCE connection-map model and writes it to the operational datastore.
 */
public class StorageRev200529 implements Rev200529 {

    private static final Logger LOG = LoggerFactory.getLogger(StorageRev200529.class);
    ...
    public boolean save(DataBroker dataBroker,
        ...
        if (connectionMap != null && !connectionMap.isEmpty()) {
            values = openRoadm.toTransportPCErev200529(connectionMap);
        }
