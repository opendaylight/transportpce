...
public abstract class AbstractConverter {
    ...
    protected AbstractBindingRuntimeContext createBindingRuntimeContext(Set<YangModuleInfo> models) {
     ...
     *
     * @return {@link Set} of loaded {@link YangModuleInfo}
     */
    protected Set<YangModuleInfo> loadModuleInfos(Set<YangModuleInfo> models) {
        if (models == null) {
