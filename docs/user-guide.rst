...
-  **feature odl-transportpce-dmaap-client**
   ...
   -  This feature is considered experimental. It provides a REST client in order to send TPCE notification
...
if your Dmaap server provides https connection through a self-signed certificate, don't forget to add the certificate
