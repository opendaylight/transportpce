...
Two kinds of topologies are currenlty implemented. The first one is the *"T0 - Multi-layer topology"*
...
abstraction, much simpler, for the specific case of 100GE transponder, in the form of a single
DSR node.
...
Its main interest is to simply and directly retreive 100GE client ports of 100G Transponders that may
