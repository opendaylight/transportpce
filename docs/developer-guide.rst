...
1. MC connectivity service from PP port to PP port of two ROADMs (Photonic Media nodes)
2. OTSi connectivity service from network port to network port of two OTN Xponders (MUXPDR or SWITCH in Photonic media layer)
3. ODU conenctivity service from network port to network port of two OTN Xponders (MUXPDR or SWITCH in DSR/ODU layer)
