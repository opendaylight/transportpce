...
Depending of the success of the service creation, different notification will be published
...
-  **ServiceCreate failed ...** : Indicates that the process of service-create failed, also contains
   the failure cause.
