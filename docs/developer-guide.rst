...
=======
`Happy path for ServiceCreate <./images/notification_diagrams/servicehandler/HappyPathServiceCreate.png>`__

`Very detailed pseudo sequence diagram <./images/notification_diagrams/servicehandler/ServiceCreateTimeSequenceDetailed.png>`__
>>>>>>> 5ed7614d6 (Add plant uml sequence diagrams in documentation)
...
=======
`Happy path for ServiceDelete <./images/notification_diagrams/servicehandler/HappyPathServiceDelete.png>`__

`Very detailed pseudo sequence diagram <images/notification_diagrams/servicehandler/ServiceDeleteTimeSequenceDetailed.png>`__
>>>>>>> 5ed7614d6 (Add plant uml sequence diagrams in documentation)
...
=======
`Overview <images/notification_diagrams/servicehandler/NetworkModelNotificationHandler.png>`__
>>>>>>> 5ed7614d6 (Add plant uml sequence diagrams in documentation)
...
=======
`Overview <images/notification_diagrams/servicehandler/PceNotificationHandler.png>`__
>>>>>>> 5ed7614d6 (Add plant uml sequence diagrams in documentation)
...
`Overview <images/notification_diagrams/servicehandler/RendererNotificationHandler.png>`__
...
* if `DELETE` is combined with a service name that is being rerouted it will try to create a new service with the
...
`Overview <images/notification_diagrams/servicehandler/ServiceListener.png>`__
