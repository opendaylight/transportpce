...
public class DeviceListener221 {
    ...
    public NotificationService.CompositeListener getCompositeListener() {
        return new NotificationService.CompositeListener(Set.of(
            new NotificationService.CompositeListener.Component<>(ChangeNotification.class, this::onChangeNotification),
            new NotificationService.CompositeListener
                .Component<>(CreateTechInfoNotification.class, this::onCreateTechInfoNotification),
            new NotificationService.CompositeListener.Component<>(OtdrScanResult.class, this::onOtdrScanResult)
        ));
    }
