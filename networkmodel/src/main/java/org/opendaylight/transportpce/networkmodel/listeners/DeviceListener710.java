            ...
            switch (edit.getTarget().getTargetType().getSimpleName()) {
                ...
                case "PortList":
                    ...
                    if (edit.getOperation().getIntValue() == 2) {
                        ...
                        String circuitPackName = edit.getTarget().firstKeyOf(PortList.class).getCircuitPackName();
                        String cpPortName = edit.getTarget().firstKeyOf(PortList.class).getPortName();
                        String lcp = this.portMapping.getMapping(this.nodeId, circuitPackName, cpPortName)
