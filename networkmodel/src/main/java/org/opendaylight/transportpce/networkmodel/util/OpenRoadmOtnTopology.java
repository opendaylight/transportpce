...
import org.opendaylight.yang.gen.v1.http.org.openroadm.otn.network.topology.rev211210.networks.network.node.TpBandwidthSharing;
...
import org.opendaylight.yang.gen.v1.http.org.openroadm.otn.network.topology.rev211210.networks.network.node.XpdrAttributes;
...
public final class OpenRoadmOtnTopology {
    ...
    private static Node createTpdr(OtnTopoNode node) {
        ...
        Node1 otnNodeAug = new Node1Builder()
            ...
            .build();
        org.opendaylight.yang.gen.v1.http.org.openroadm.common.network.rev211210.Node1 ocnNodeAug =
    ...
    private static Class<? extends OduRateIdentity> fixRate(List<Class<? extends org.opendaylight.yang.gen.v1.http
            .org.openroadm.port.types.rev200327.SupportedIfCapability>> list) {
        ...
        for (Class<? extends org.opendaylight.yang.gen.v1.http.org.openroadm.port.types.rev200327
                .SupportedIfCapability> class1 : list) {
    ...
    private static TerminationPoint buildIetfTp(
        ...
        org.opendaylight.yang.gen.v1.http.org.openroadm.common.network.rev211210.TerminationPoint1 ocnTp =
