...
public interface NetworkModelService {
     ...
     *
     * @param nodeTps
     *   Map containing the nodeId as key, and the termination point supporting
     ...
     */
    void updateOtnLinks(Map<String, String> nodeTps, String serviceRate, Short tribPortNb, Short tribSoltNb,
        boolean isDeletion);
