...
public class ClliNetworkTest {
    ...
    public void createNodeTest() {
        //prepare data test
        NodeInfoBuilder nodeBldr = computeNodeInfoBuilder();
        NodeInfo nodeInfo = nodeBldr.build();
    ...
    public void createNodeWithNullDeviceIdTest() {
        NodeInfoBuilder nodeBldr = computeNodeInfoBuilder();
        Node createdNode = ClliNetwork.createNode(null, nodeBldr.build());
        assertNull("SupportingNode should be null", createdNode.getSupportingNode());
    ...
    private NodeInfoBuilder computeNodeInfoBuilder() {
        ...
        nodeBldr.setNodeClli("NodeClliId");
        nodeBldr.setNodeModel("NodeModel");
        nodeBldr.setNodeIpAddress(new IpAddress(new Ipv4Address("127.0.0.1")));
        nodeBldr.setNodeType(NodeTypes.Xpdr);
        nodeBldr.setNodeVendor("VendorA");
        nodeBldr.setOpenroadmVersion(OpenroadmVersion._121);
        return nodeBldr;
    }
