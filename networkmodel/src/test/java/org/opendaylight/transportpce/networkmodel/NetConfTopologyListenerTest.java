...
public class NetConfTopologyListenerTest {
    ...
    @Mock
    private R2RLinkDiscovery linkDiskovery;
    ...
    public void testOnDataTreeChanged() {
        ...
        R2RLinkDiscovery linkDiskovery = new R2RLinkDiscovery(dataBroker,deviceTransactionManager,networkTransactionService);
