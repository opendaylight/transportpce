...
public final class NetworkmodelTestUtil {
     ...
     * @return a {@link org.opendaylight.yang.gen.v1.http.org.opendaylight.transportpce.portmapping.rev260811
            ...
            new LinkBuilder()
                ...
                .addAugmentation(
                    new Link1Builder()
                        ...
                        .build())
                .addAugmentation(
                    new org.opendaylight.yang.gen.v1.http.org.openroadm.otn.network.topology.rev250530
                            .Link1Builder()
