...
public class WeightedResultMessage implements Message {
    ...
    @Override
    public String deviceRenderingResultMessage(List<DeviceRenderingResult> renderingResults, String defaultErrorMessage,
    ...
    @Override
    public String olmRenderingResultMessage(List<OLMRenderingResult> renderingResults, String defaultErrorMessage,
            String defaultSuccessMessage) {
