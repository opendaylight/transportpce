...
import org.opendaylight.yang.gen.v1.http.org.openroadm.common.service.types.rev210924.service.Topology;
import org.opendaylight.yang.gen.v1.http.org.openroadm.common.service.types.rev210924.service.TopologyBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.device.rev170206.get.connection.port.trail.output.Ports;
import org.opendaylight.yang.gen.v1.http.org.openroadm.resource.rev210924.resource.DeviceBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.resource.rev210924.resource.ResourceBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.resource.rev210924.resource.ResourceTypeBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.resource.rev210924.resource.resource.resource.port.PortBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.resource.types.rev210924.ResourceTypeEnum;
import org.opendaylight.yang.gen.v1.http.org.openroadm.topology.rev210924.Hop.HopType;
import org.opendaylight.yang.gen.v1.http.org.openroadm.topology.rev210924.topology.AToZ;
import org.opendaylight.yang.gen.v1.http.org.openroadm.topology.rev210924.topology.AToZBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.topology.rev210924.topology.AToZKey;
import org.opendaylight.yang.gen.v1.http.org.openroadm.topology.rev210924.topology.ZToA;
import org.opendaylight.yang.gen.v1.http.org.openroadm.topology.rev210924.topology.ZToABuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.topology.rev210924.topology.ZToAKey;
...
public class ServiceListTopology {
    ...
    public void updateAtoZTopologyList(List<Ports> ports, String nodeId) {
        ...
        for (Ports port : ports) {
            ...
            org.opendaylight.yang.gen.v1.http.org.openroadm.resource.rev210924.resource.resource.resource
                    .PortBuilder portCase =
                    new org.opendaylight.yang.gen.v1.http.org.openroadm.resource.rev210924.resource.resource.resource
                            .PortBuilder();
