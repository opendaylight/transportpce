...
import org.opendaylight.yang.gen.v1.http.org.openroadm.resource.rev250530.resource.resource.resource.port.PortBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.resource.types.rev250530.ResourceTypeEnum;
import org.opendaylight.yang.gen.v1.http.org.openroadm.topology.rev250530.Hop.HopType;
import org.opendaylight.yang.gen.v1.http.org.openroadm.topology.rev250530.topology.AToZ;
import org.opendaylight.yang.gen.v1.http.org.openroadm.topology.rev250530.topology.AToZBuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.topology.rev250530.topology.AToZKey;
import org.opendaylight.yang.gen.v1.http.org.openroadm.topology.rev250530.topology.ZToA;
import org.opendaylight.yang.gen.v1.http.org.openroadm.topology.rev250530.topology.ZToABuilder;
import org.opendaylight.yang.gen.v1.http.org.openroadm.topology.rev250530.topology.ZToAKey;
        ...
        for (Ports port : ports) {
            ...
            AToZ a2z = new AToZBuilder()
                ...
                .setResource(new ResourceBuilder()
                    .setResource(new org.opendaylight.yang.gen.v1.http.org.openroadm.resource.rev250530
