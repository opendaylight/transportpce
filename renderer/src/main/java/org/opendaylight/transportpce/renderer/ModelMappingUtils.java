...
import org.opendaylight.yang.gen.v1.http.org.transportpce.b.c._interface.pathdescription.rev251001.PathDescription;
...
import org.opendaylight.yang.gen.v1.http.org.transportpce.b.c._interface.pathdescription.rev251001.pce.resource.resource.Resource;
...
public final class ModelMappingUtils {
    ...
    public static ServicePathInputData rendererCreateServiceInputAToZ(String serviceName,
        ...
        ServicePathInputBuilder servicePathInputBuilder = new ServicePathInputBuilder()
            ...
            .setOperationalMode(pathDescription.getAToZDirection().getAtxOperationalMode())
        ...
        if (atoZDirection.getOpticalOperationalMode() != null) {
            servicePathInputBuilder.setOperationalMode(atoZDirection.getOpticalOperationalMode());
        }
    ...
    public static ServicePathInputData rendererCreateServiceInputZToA(String serviceName,
        ...
        ServicePathInputBuilder servicePathInputBuilder = new ServicePathInputBuilder()
            ...
            .setOperationalMode(pathDescription.getZToADirection().getZtxOperationalMode())
            .setNodes(nodeLists.getRendererNodeList());
        ...
        if (ztoADirection.getOpticalOperationalMode() != null) {
            servicePathInputBuilder.setOperationalMode(ztoADirection.getOpticalOperationalMode());
        }
