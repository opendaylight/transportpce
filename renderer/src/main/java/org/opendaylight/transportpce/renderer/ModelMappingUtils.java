...
public final class ModelMappingUtils {
    ...
    public static OtnServicePathInput rendererCreateOtnServiceInput(String serviceName, Action operation,
        ...
        if (serviceRate.intValue() == 100) {
            ...
            OpucnTribSlotDef minTribSlotNumber = pathDescription.getAToZDirection().getMinTribSlot();
            OpucnTribSlotDef maxTribSlotNumber = pathDescription.getAToZDirection().getMaxTribSlot();
            opucnTribSlotDefList.add(minTribSlotNumber);
            opucnTribSlotDefList.add(maxTribSlotNumber);
