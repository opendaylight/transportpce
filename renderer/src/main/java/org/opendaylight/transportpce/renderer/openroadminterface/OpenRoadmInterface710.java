...
public class OpenRoadmInterface710 {
    ...
    private  static final String MISSING_OPERATIONAL_MODE =
            "For Profile based provisioning optical operational mode should not be empty";
    ...
    public String createOpenRoadmOtsiInterface(String nodeId, String logicalConnPoint,
                                               SpectrumInformation spectrumInformation, String
                                               operationalMode, String provisionMode)
            throws OpenRoadmInterfaceException {
        ModulationFormat modulationFormat = ModulationFormat.forName(spectrumInformation.getModulationFormat());
        if (modulationFormat == null) {
        ...
        if (provisionMode.equals("profile")) {
            // TODO: Also provisioning mode can be mbased on media-id; This needs to be added later
            if (operationalMode == null) {
                throw new OpenRoadmInterfaceException(MISSING_OPERATIONAL_MODE);
            }
            LOG.info("Using {} based provisioning for optical operational mode {}", provisionMode, operationalMode);
    ...
    public String createOpenRoadmOchOtsiOtsigroupInterface(String nodeId, String logicalConnPoint,
            SpectrumInformation spectrumInformation, String operationalMode, String provisionMode)
            throws OpenRoadmInterfaceException {
        Mapping portMap = portMapping.getMapping(nodeId, logicalConnPoint);
        if (portMap == null) {
            throw new OpenRoadmInterfaceException(
