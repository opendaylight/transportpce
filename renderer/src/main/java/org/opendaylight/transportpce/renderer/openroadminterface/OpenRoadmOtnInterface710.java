...
public class OpenRoadmOtnInterface710 {
    ...
    public String createOpenRoadmEth100GInterface(String nodeId,
        ...
        ethInterfaceBldr.addAugmentation(new Interface1Builder().setEthernet(ethIfBuilder.build()).build());
    ...
    public String createOpenRoadmOdu4Interface(String nodeId, String logicalConnPoint,
        ...
        String supportingInterface = isNetworkPort ? portMap.getSupportingOduc4() : logicalConnPoint + "-ETHERNET100G";
        ...
        if (isNetworkPort) {
           ...
           //  This is for the client side of the ODU (ODU-TTP-CTP)
            // Set Opu attributes
            oduBuilder.setOpu(new OpuBuilder()
