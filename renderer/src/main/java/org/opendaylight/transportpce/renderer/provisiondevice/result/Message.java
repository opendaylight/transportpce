...
public interface Message {
     ...
     */
    String deviceRenderingResultMessage(List<DeviceRenderingResult> renderingResults, String defaultErrorMessage,
            String defaultSuccessMessage);

    /**
     * Turn a list of rendering results into one 'weighted' response.
     */
    String olmRenderingResultMessage(List<OLMRenderingResult> renderingResults, String defaultErrorMessage,
            String defaultSuccessMessage);
