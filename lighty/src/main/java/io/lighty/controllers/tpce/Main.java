    ...
    public void start(String[] args, boolean registerShutdownHook) {
        ...
        try {
            ...
            ControllerConfiguration singleNodeConfiguration = ControllerConfigUtils
                    .getDefaultSingleNodeConfiguration(TPCEUtils.yangModels);
            ...
            throw new TechnicalException("An error occured while starting application");
        } catch (InterruptedException e) {
            LOG.error("Application start interrupted : ", e);
            Thread.currentThread().interrupt();
            throw new TechnicalException("Application start interrupted");
        } catch (Exception e) {
            LOG.error("Application start unmanaged exception : ", e);
            throw new TechnicalException("Application start unmanaged exception");
