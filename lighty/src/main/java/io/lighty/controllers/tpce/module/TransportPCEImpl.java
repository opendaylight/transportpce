...
import org.opendaylight.transportpce.common.kafka.KafkaImpl;
    ...
    */
    ...
    public TransportPCEImpl(LightyServices lightyServices) {
        ...
        */
        ...
        networkModelService = new NetworkModelServiceImpl(networkTransaction, linkDiscoveryImpl, deviceTransactionManager, openRoadmFactory, portMapping, lightyServices.getBindingNotificationPublishService());
