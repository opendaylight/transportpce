...
public class TransportPCEImpl extends AbstractLightyModule implements TransportPCE {
    ...
    public TransportPCEImpl(LightyServices lightyServices) {
        ...
        TransportpceNetworkutilsService networkutilsServiceImpl = new NetworkUtilsImpl(lightyServices.getBindingDataBroker());
     ...
     * @param rendererServiceOperations
     * @param networkModelWavelengthService
     * @return TapiProvider instance
     */
    private TapiProvider initTapi(LightyServices lightyServices,
            RendererServiceOperations rendererServiceOperations,
            NetworkModelWavelengthService networkModelWavelengthService, PathComputationService pathComputationService) {
     ...
     * @param networkModelWavelengthService
     * @param deviceRendererService
     * @param otnDeviceRendererService
    ...
    private OpenRoadmInterfaceFactory initOpenRoadmFactory(MappingUtils mappingUtils,
        ...
        OpenRoadmOtnInterface221 openRoadmOtnInterface221 = new OpenRoadmOtnInterface221(portMapping,
                openRoadmInterfaces);
        return new OpenRoadmInterfaceFactory(mappingUtils,
                openRoadmInterface121, openRoadmInterface221, openRoadmOtnInterface221);
    }
    ...
    private PortMapping initPortMapping(LightyServices lightyServices,
        ...
        PortMappingVersion121 portMappingVersion121 = new PortMappingVersion121(lightyServices.getBindingDataBroker(),
                deviceTransactionManager, openRoadmInterfaces);
        return new PortMappingImpl(lightyServices.getBindingDataBroker(), portMappingVersion221,
    ...
    private OpenRoadmInterfaces initOpenRoadmInterfaces(MappingUtils mappingUtils) {
        ...
        OpenRoadmInterfacesImpl221 openRoadmInterfacesImpl221 = new OpenRoadmInterfacesImpl221(
                deviceTransactionManager);
        return  new OpenRoadmInterfacesImpl(deviceTransactionManager,
                mappingUtils, openRoadmInterfacesImpl121, openRoadmInterfacesImpl221);
    }
    ...
    private CrossConnect initCrossConnect(MappingUtils mappingUtils) {
        ...
        return new CrossConnectImpl(deviceTransactionManager, mappingUtils,
                crossConnectImpl121, crossConnectImpl221);
    }
}