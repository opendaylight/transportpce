...
public class PceORLink implements Serializable, PceLink {

    /* Logging. */
    private static final Logger LOG = LoggerFactory.getLogger(PceORLink.class);
    ///////////////////////// LINKS ////////////////////
    /*
    ...
    private LinkId calcOpposite(Link link) {
        ...
        if (tmpoppositeLink == null) {
            LOG.error("PceLink:calcOpposite: Error calcOpposite. Link is ignored {}", link.getLinkId().getValue());
            isValid = false;
        }
