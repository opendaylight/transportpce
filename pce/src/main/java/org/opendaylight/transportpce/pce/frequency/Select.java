...
public interface Select {
     ...
     *
     * <p>Selecting a frequency range may depend on multiple factors.
     *
     * <p>A) API input.
     ...
     *
     * <p>If any of the requirements cannot be met, an empty BitSet should be returned. Meaning there is
