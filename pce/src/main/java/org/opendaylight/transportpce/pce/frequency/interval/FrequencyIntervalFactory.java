...
public class FrequencyIntervalFactory implements IntervalFactory {
    ...
    @Override
    public Interval interval(BigDecimal centerFrequencyTHz, BigDecimal slotFrequencyGHz, int slots) {
        return new FrequencyInterval(
                lowerFrequency(centerFrequencyTHz, slotFrequencyGHz.doubleValue(), slots),
                upperFrequency(centerFrequencyTHz, slotFrequencyGHz.doubleValue(), slots)
        );
    }
    ...
    public BigDecimal lowerFrequency(BigDecimal centerFrequencyTHz, Double slotFrequencyGHz, int slots) {
        return centerFrequencyTHz
                .subtract(
                        BigDecimal.valueOf(slotFrequencyGHz)
    ...
    public BigDecimal upperFrequency(BigDecimal centerFrequencyTHz, Double slotFrequencyGHz, int slots) {
        return centerFrequencyTHz
                .add(
                        BigDecimal.valueOf(slotFrequencyGHz)
                                .multiply(BigDecimal.valueOf(0.001))
