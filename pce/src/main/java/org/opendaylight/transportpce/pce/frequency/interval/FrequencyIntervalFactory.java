...
public class FrequencyIntervalFactory implements IntervalFactory {
    ...
    @Override
    public Interval interval(BigDecimal centerFrequencyTHz, BigDecimal slotFrequencyWidthGHz, int slots) {
        return new FrequencyInterval(
                lowerFrequency(centerFrequencyTHz, slotFrequencyWidthGHz.doubleValue(), slots),
                upperFrequency(centerFrequencyTHz, slotFrequencyWidthGHz.doubleValue(), slots)
        );
    }
    ...
    public BigDecimal lowerFrequency(BigDecimal centerFrequencyTHz, Double slotFrequencyWidthGHz, int slots) {
        ...
        return centerFrequencyTHz
                .subtract(
                        BigDecimal.valueOf(slotFrequencyWidthGHz)
    ...
    public BigDecimal upperFrequency(BigDecimal centerFrequencyTHz, Double slotFrequencyWidthGHz, int slots) {
