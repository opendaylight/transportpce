...
public class SpectrumIndex implements Index {
    ...
    public int firstCenterFrequencyIndex(
        ...
        LOG.info("First possible center frequency slot index {} (center frequency slot width {}, base frequency slot"
                        + " index {}, service slot width {}", slotIndexCandidate, centerFrequencySlotWidth,
                baseFrequencySlotIndex, serviceSlotWidth);
    ...
    public int lastCenterFrequencyIndex(int centerFrequencySlotWidth, int baseFrequencySlotIndex, int serviceSlotWidth,
        ...
        LOG.info("Last possible center frequency slot index {} (center frequency slot width {}, base frequency slot"
                        + " index {}, service slot width {}, effective bits {})", slotIndexCandidate,
                centerFrequencySlotWidth, baseFrequencySlotIndex, serviceSlotWidth, effectiveBits);
