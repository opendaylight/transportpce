...
public class PostAlgoPathValidator {
    ...
    private double checkOSNRaz(GraphPath<String, PceGraphEdge> path, Map<NodeId, PceNode> allPceNodes,
        ...
        Map<String, Double> signal = new HashMap<>(
            Map.of(
                ...
                "calcOsnrLin", Double.valueOf(0.0001),
        ...
        for (int pathElement = 0; pathElement < 2; pathElement++) {
            ...
            switch (currentNode.getORNodeType()) {
                ...
                case SRG:
                    ...
                    double calcOsnr = signal.get("calcOsnrLin").doubleValue();
                    if (calcOsnr == Double.NEGATIVE_INFINITY || calcOsnr == Double.POSITIVE_INFINITY) {
                        return -1.0;
                    }
                ...
                case DEGREE:
                    ...
                    double calcOsnrLin = signal.get("calcOsnrLin").doubleValue();
                    LOG.debug(
        ...
        for (int pathElement = 2 + bypassDegree; pathElement < vertices.size() - 1; pathElement++) {
            ...
            switch (currentNode.getORNodeType()) {
                ...
                case SRG:
                    ...
                    try {
                        calcOsnrdB = getOsnrDbfromOsnrLin(calcOsnr);
        ...
        LOG.info("- In checkOSNR: accumulated CD = {} ps, PMD = {} ps, PDL = {} dB, and resulting OSNR calcOsnrdB = {} "
            ...
            Math.sqrt(signal.get("calcPdl2").doubleValue()), calcOsnrdB,
            getOsnrDbfromOsnrLin(signal.get("calcOsnrLin").doubleValue()));
    ...
    private void xpdrCheckOSNR(
        ...
        signal.put("calcOsnrLin", Double.valueOf(calcOsnrLin));
    }
    ...
    private void srgCheckOSNR(
        ...
        calcDegradationOSNR(cu, signal, pceLink);
        ...
        signal.putAll(
            Map.of(
                ...
                "calcOsnrLin", impairments.get("ONSRLIN")));
    }
    ...
    private void degreeCheckOSNR(CatalogUtils cu, Map<String, Double> signal,
        ...
        calcDegradationOSNR(cu, signal, pceLink0);
    ...
    private void calcDegradationOSNR(CatalogUtils cu, Map<String, Double> signal, PceLink pceLink) {
