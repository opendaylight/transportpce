        ...
        for (org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.network.topology.rev180226.networks.network
            ...
            switch (type) {
                ...
                case SRGTXRXPP:
                    ...
                    try {
                        List<UsedWavelength> usedWavelengths = new ArrayList(nttp1.getPpAttributes().getUsedWavelength().values());
        ...
        switch (this.nodeType) {
            ...
            case DEGREE :
                List<org.opendaylight.yang.gen.v1.http.org.openroadm.degree.rev181130.degree.node.attributes
                    .AvailableWavelengths> degAvailableWL = new ArrayList(node1.getDegreeAttributes().getAvailableWavelengths().values());
