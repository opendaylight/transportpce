        ...
        switch (rc.getServiceType()) {
            ...
            case StringConstants.SERVICE_TYPE_ODUC4:
                if (rc.getResultTribSlot() != null && rc.getResultTribPort() != null) {
                    ...
                    OpucnTribSlotDef minOpucnTs = OpucnTribSlotDef.getDefaultInstance(tribSlotList.get(0).toString());
                    OpucnTribSlotDef maxOpucnTs = OpucnTribSlotDef.getDefaultInstance(tribSlotList
                            .get(tribSlotList.size() - 1).toString());
                    List<OpucnTribSlotDef> opucnTSlotDefList = new ArrayList<>();
                    opucnTSlotDefList.add(minOpucnTs);
                    opucnTSlotDefList.add(maxOpucnTs);
                    atoZDirectionBldr.setAToZWavelengthNumber(Uint32.valueOf(0))
                            ...
                            .setOpucnTribSlots(opucnTSlotDefList);
                } else {
