    ...
    private AToZDirectionBuilder buildAtoZDirection(Map<AToZKey, AToZ> atozMap) {
        ...
        switch (rc.getServiceType()) {
            ...
            case StringConstants.SERVICE_TYPE_OTU4:
                FrequencyTHz maxFreq = new FrequencyTHz(Decimal64.valueOf(rc.getMaxFreq()));
                FrequencyTHz minFreq = new FrequencyTHz(Decimal64.valueOf(rc.getMinFreq()));
                atoZDirectionBldr.setAToZMaxFrequency(maxFreq);
                atoZDirectionBldr.setAToZMinFrequency(minFreq);
    ...
    private ZToADirectionBuilder buildZtoADirection(Map<ZToAKey, ZToA> ztoaMap) {
        ...
        switch (rc.getServiceType()) {
            ...
            case StringConstants.SERVICE_TYPE_OTU4:
                FrequencyTHz maxFreq = new FrequencyTHz(Decimal64.valueOf(rc.getMaxFreq()));
                FrequencyTHz minFreq = new FrequencyTHz(Decimal64.valueOf(rc.getMinFreq()));
                ztoADirectionBldr.setZToAMaxFrequency(maxFreq);
                ztoADirectionBldr.setZToAMinFrequency(minFreq);
