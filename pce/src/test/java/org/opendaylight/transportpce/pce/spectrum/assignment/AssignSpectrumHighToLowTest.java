...
class AssignSpectrumHighToLowTest {
    ...
    @Test
    @DisplayName("When first bits are available twice the center-frequency granularity, range() should adjust correctly")
    ...
    @Test
    @DisplayName("When available range and located at the lowest frequencies and is smaller than requested bandwidth, range() should return an empty range (0,0)")
