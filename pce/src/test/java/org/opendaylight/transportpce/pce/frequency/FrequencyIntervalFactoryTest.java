...
import org.opendaylight.transportpce.pce.frequency.interval.InvalidIntervalException;
...
import org.opendaylight.yang.gen.v1.http.org.opendaylight.transportpce.service.spectrum.constraint.rev230907.spectrum.allocation.FrequencyRangeBuilder;
...
class FrequencyIntervalFactoryTest {
    ...
    @Test
    void lowerFrequencyWithOddSlots_throwsException() {
        FrequencyIntervalFactory frequencyIntervalFactory = new FrequencyIntervalFactory(
                new ServiceFrequency(),
                768,
                6.25
    ...
    @Test
    void upperFrequencyWithOddSlots_throwsException() {
        FrequencyIntervalFactory frequencyIntervalFactory = new FrequencyIntervalFactory(
                new ServiceFrequency(),
                768,
                6.25
