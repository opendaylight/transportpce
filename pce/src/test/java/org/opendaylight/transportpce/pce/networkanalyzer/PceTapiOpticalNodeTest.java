   ...
   //SPDR-SC1-XPDR2+XPONDER
    ...
    void testvalidateAZxponderForXPDR1() {
       ...
       //SPDR-SC1-XPDR1+DSR+XPDR1-CLIENT2 UUID = "b877533a-99ce-3128-bfb2-dc7e0a2122dd"
        ...
        List<PceTapiOpticalNode> pceTapiXpdrNodesSpdrAx1 = tapiONspdrAx1.getPceNodeMap().entrySet().stream()
            .map(Map.Entry::getValue)
...
//            "SPDR-SA1-XPDR1+PHOTONIC_MEDIA_OTS network Port shall be available");
        assertEquals("82998ece-51cd-3c07-8b68-59d5ad5ff39e", pceONspdrSA1
            .getXpdrNWfromClient("21efd6a4-2d81-3cdb-aabb-b983fb61904e"),
