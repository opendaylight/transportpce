...
class ValidInputTest {
    ...
    void assertEmptyPCRIisValid() {
        ValidInput validateInput = new ValidInput(Mockito.mock(Slot.class));
    ...
    void isValidZEndSlot() {
        ...
        ValidInput validateInput = new ValidInput(mock);
    ...
    void assertSlotErrorMessageIsPassedUpTheCallStack() {
        ...
        ValidInput validateInput = new ValidInput(slot);
        ...
        })).when(slot).isValidSlot(BigDecimal.valueOf(191.33125), BigDecimal.valueOf(12.5), validateInput);
    ...
    void assertSlotWidthErrorMessageIsPassedUpTheCallStack() {
        ...
        })).when(slot).isValidSlotWidth(BigDecimal.valueOf(12.5), validateInput);
    ...
    void assertSubsequentValidationsResetLastErrorMessage() {
        ...
        //message to the observer (argument1, i.e. validateInput). Note the value '12.5'.
        doAnswer(answer(new Answer2<Boolean, BigDecimal, Observer>() {
            @Override
            public Boolean answer(BigDecimal argument0, Observer argument1) throws Throwable {
                argument1.error("An error occurred");
        ...
        // produce an input validation error. Note the value '12.5'.
