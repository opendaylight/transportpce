...
public final class NodeUtils {
    ...
    public static LinkBuilder createAdd(String srcNode, String destNode, String srcTp, String destTp) {
        Link1Builder link1Builder = new Link1Builder()
                ...
                .setAdministrativeState(AdminStates.InService)
                .setOperationalState(State.InService);
        return createLinkBuilder(false, srcNode, destNode, srcTp, destTp, link1Builder);
    }
    ...
    public static NodeBuilder getDegNodeBuilder(Map<SupportingNodeKey, SupportingNode> supportingNodes, String nodeId) {
        ...
        TerminationPoint1Builder tp1Bldr = new TerminationPoint1Builder();
        TerminationPoint1Builder tp2Bldr = new TerminationPoint1Builder();
        tp1Bldr.setTpType(OpenroadmTpType.DEGREETXRXTTP).setAdministrativeState(AdminStates.InService)
            .setOperationalState(State.InService);
        TerminationPointBuilder degTtpBldr = new TerminationPointBuilder()
            .withKey(new TerminationPointKey(new TpId("DEG1-TTP-TXRX")));
        degTtpBldr.addAugmentation(tp1Bldr.build());
        TerminationPoint degTTP = degTtpBldr.build();
        tp2Bldr.setTpType(OpenroadmTpType.DEGREETXRXCTP).setAdministrativeState(AdminStates.InService)
        .setOperationalState(State.InService);
        TerminationPointBuilder degCtpBldr = new TerminationPointBuilder()
            .withKey(new TerminationPointKey(new TpId("DEG1-CTP-TXRX")));
        degCtpBldr.addAugmentation(tp2Bldr.build());
        TerminationPoint degCTP = degCtpBldr.build();
        org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.network.topology.rev180226
            .Node1 node1 = new Node1Builder()
                .setTerminationPoint(Map.of(degTTP.key(), degTTP, degCTP.key(), degCTP)).build();
    ...
    public static NodeBuilder getSrgNodeBuilder(Map<SupportingNodeKey, SupportingNode> supportingNodes, String nodeId) {
        // update tp of nodes
        TerminationPointBuilder srgPpBldr = new TerminationPointBuilder()
            .withKey(new TerminationPointKey(new TpId("SRG1-PP-TXRX")));
        TerminationPoint1Builder tp1Bldr = new TerminationPoint1Builder();
        TerminationPoint1Builder tp2Bldr = new TerminationPoint1Builder();
        tp1Bldr.setTpType(OpenroadmTpType.SRGTXRXPP).setAdministrativeState(AdminStates.InService)
            .setOperationalState(State.InService);
        srgPpBldr.addAugmentation(tp1Bldr.build());
        TerminationPoint srgPP = srgPpBldr.build();
        tp2Bldr.setTpType(OpenroadmTpType.SRGTXRXCP).setAdministrativeState(AdminStates.InService)
        .setOperationalState(State.InService);
        TerminationPointBuilder srgCpBldr = new TerminationPointBuilder()
            .withKey(new TerminationPointKey(new TpId("SRG1-CP-TXRX")));
        srgCpBldr.addAugmentation(tp2Bldr.build());
        TerminationPoint srgCP = srgCpBldr.build();
        org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.network.topology.rev180226
            .Node1 node1 = new Node1Builder()
