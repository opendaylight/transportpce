...
class CenterFrequencyGranularityCollectionTest {
    ...
    void testDefault() {
        Collection collection = new CenterFrequencyGranularityCollection(50);
        Assertions.assertEquals(BigDecimal.valueOf(50), collection.leastCommonMultiplierInGHz());
    }
    ...
    @Test
    void leastCommonMultiplierOnlyIntegersInGHz() {
        Collection collection = new CenterFrequencyGranularityCollection(50);
        collection.add(6);
        collection.add(12);
        collection.add(18);

        Assertions.assertEquals(BigDecimal.valueOf(36), collection.leastCommonMultiplierInGHz());
    }

    @Test
    void leastCommonMultiplierDecimalInGHz() {
        Collection collection = new CenterFrequencyGranularityCollection(50);
        collection.add(50.0);
        collection.add(6.25);
        collection.add(75);
        ...
        Assertions.assertEquals(BigDecimal.valueOf(150), collection.leastCommonMultiplierInGHz());
    }
    ...
    void testUnevenSlotsThrowsException() {
        ...
        Assertions.assertThrows(LeastCommonMultiplierException.class,() -> collection.slots(6.25));
    }
