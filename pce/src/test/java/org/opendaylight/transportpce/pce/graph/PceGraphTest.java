...
//    @Test
//    public void clacPath100GE() {
//        pceGraph = new PceGraph(pceOpticalNode1, pceOpticalNode2, allPceNodes,
//            allPceLinks, pceHardConstraints,
//            null, rc,
//            StringConstants.SERVICE_TYPE_100GE_T, null);
//
//        Assert.assertEquals(pceGraph.calcPath(), false);
//    }
    ...
    public static Node createNetworkNode(String nodeId, OpenroadmNodeType nodeType) {
        ...
        node2Bldr.setNodeType(nodeType);
        node1Bldr.setOpenroadmVersion(OpenroadmVersionType._221);
    ...
    public static TerminationPoint createNetworkTp(String nodeId, String tpId) {
        var tpb = new TerminationPointBuilder();
        TerminationPoint1Builder tp1b = new TerminationPoint1Builder();
        tp1b.setXpdrNetworkAttributes(new XpdrNetworkAttributesBuilder().setState(State.InService).build());

        return tpb
            .setTpId(new TpId(tpId))
            .withKey(new TerminationPointKey(new TpId(tpId)))
            .addAugmentation(tp1b.build())
            .build();
    }
    ...
    public static Node createTopologyNode(String nodeId, OpenroadmNodeType nodeType) {
        ...
        var node2Bldr = new org.opendaylight.yang.gen.v1.http.org.openroadm.common.network.rev211210.Node1Builder();
        node2Bldr.setNodeType(nodeType);
        node1Bldr.setXpdrAttributes(null);
        SupportingNode supportingNode = new SupportingNodeBuilder()
