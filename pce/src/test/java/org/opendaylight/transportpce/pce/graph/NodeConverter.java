...
/**
 * Converter for Node objects.
 * This class implements the XStream Converter interface to marshal and unmarshal
 * Node objects to and from XML format.
 *
 * <p>Specifically needed when reading xml files in the folder test/resources/topology/nodes/
 * during unit tests. The element {@code<node>} is processed using this converter.
 */
