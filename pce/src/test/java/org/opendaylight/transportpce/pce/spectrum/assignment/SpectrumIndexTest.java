...
class SpectrumIndexTest {
    ...
    @Test
    void highighToLowowCenterFrequencyGranularityEqualToServiceSlotWidth() {
        ...
        Assertions.assertEquals(764, spectrumIndex.lastCenterFrequencyIndex(8, 284, 8, 768));
    ...
    void highToLowCenterFrequencyGranularityLessThanServiceSlotWidth() {
        ...
        Assertions.assertEquals(764, spectrumIndex.lastCenterFrequencyIndex(2, 284, 8, 768));
    ...
    void highToLowMinimumCenterFrequencyGranularityLessThanServiceSlotWidth() {
        ...
        Assertions.assertEquals(764, spectrumIndex.lastCenterFrequencyIndex(1, 284, 8, 768));
    ...
    void highToLowCenterFrequencyGranularityMoreThanServiceSlotWidth() {
        ...
        Assertions.assertEquals(764, spectrumIndex.lastCenterFrequencyIndex(16, 284, 8, 768));
    ...
    void highToLowCenterFrequencyGranularityLessThanServiceSlotWidths() {
        ...
        // (i.e. possible center frequencies are at ..., 284, 300, 316, ..., 732, 748, 764)
        Assertions.assertEquals(748, spectrumIndex.lastCenterFrequencyIndex(16, 284, 26, 768));
    ...
    void highToLowCenterFrequencyGranularityMoreThanServiceSlotWidthDifferentReferenceIndex() {
        ...
        Assertions.assertEquals(760, spectrumIndex.lastCenterFrequencyIndex(16, 280, 8, 768));
