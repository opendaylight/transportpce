...
class ClientPreferenceTest {
    ...
    void preferredPort_returnTrue() {
        ...
        Assertions.assertTrue(clientPreference.preferredPort("ROADM-B-SRG1", "SRG1-PP1-TXRX"));
    }
    ...
    void nonPreferredPort_returnFalse() {
        ...
        Assertions.assertFalse(clientPreference.preferredPort("ROADM-B-SRG1", "SRG1-PP2-TXRX"));
    }
    ...
    void nodeMissingInPreferredList_returnTrue() {
        ...
        Assertions.assertTrue(clientPreference.preferredPort("ROADM-A-SRG1", "SRG1-PP2-TXRX"));
