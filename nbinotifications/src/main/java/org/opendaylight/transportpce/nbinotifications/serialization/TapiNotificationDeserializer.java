...
import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.notification.rev181210.notification.Name;
import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.notification.rev181210.notification.NameBuilder;
import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.notification.rev181210.notification.NameKey;
...
public class TapiNotificationDeserializer implements Deserializer<Notification> {
    ...
    public Notification deserialize(String topic, byte[] data) {
        ...
        return new NotificationBuilder(transformNotificationTapiService(mappedString)).build();
    }
    ...
    private Notification transformNotificationTapiService(NotificationTapiService mappedString) {
        ...
        if (mappedString.getName() != null) {
            for (org.opendaylight.yang.gen.v1
                    .nbi.notifications.rev211013.notification.tapi.service.Name name:mappedString.getName().values()) {
