...
import org.opendaylight.yang.gen.v1.nbi.notifications.rev201130.get.notifications.alarm.service.output.NotificationAlarmServiceBuilder;
...
public class NotificationAlarmServiceDeserializer implements Deserializer<NotificationAlarmService> {
    ...
    private JsonStringConverter<org.opendaylight.yang.gen.v1
        .nbi.notifications.rev201130.NotificationAlarmService> converter;
    ...
    public void configure(Map<String, ?> configs, boolean isKey) {
        ...
        if (configs.containsKey(ConfigConstants.CONVERTER)
            ...
            converter = (JsonStringConverter<org.opendaylight.yang.gen.v1
                    .nbi.notifications.rev201130.NotificationAlarmService>) configs
    ...
    public NotificationAlarmService deserialize(String topic, byte[] data) {
        ...
        org.opendaylight.yang.gen.v1.nbi.notifications.rev201130.NotificationAlarmService mappedString = converter
                .createDataObjectFromJsonString(YangInstanceIdentifier.of(
                        org.opendaylight.yang.gen.v1.nbi.notifications.rev201130.NotificationAlarmService.QNAME),
                        value,
