...
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.NotificationAlarmServiceBuilder;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.NotificationProcessService;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.NotificationProcessServiceBuilder;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.NotificationTapiService;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.NotificationTapiServiceBuilder;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.PublishNotificationAlarmService;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.PublishNotificationProcessService;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.PublishTapiNotificationService;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.TapiTopicNotification;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.notification.tapi.service.AdditionalInfo;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.notification.tapi.service.AdditionalInfoBuilder;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.notification.tapi.service.AdditionalInfoKey;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.notification.tapi.service.AlarmInfoBuilder;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.notification.tapi.service.ChangedAttributes;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.notification.tapi.service.ChangedAttributesBuilder;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.notification.tapi.service.ChangedAttributesKey;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.notification.tapi.service.Name;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.notification.tapi.service.NameBuilder;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.notification.tapi.service.NameKey;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.notification.tapi.service.TargetObjectName;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.notification.tapi.service.TargetObjectNameBuilder;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.notification.tapi.service.TargetObjectNameKey;
import org.opendaylight.yang.gen.v1.nbi.notifications.rev211021.notification.tapi.service.TcaInfoBuilder;
...
public class NbiNotificationsListenerImpl implements NbiNotificationsListener {
    ...
    @Override
    public void onTapiTopicNotification(TapiTopicNotification notification) {
        LOG.info("Received request for creating tapi topic");
        TopicManager topicManager = TopicManager.getInstance();
        topicManager.addTapiTopic(notification.getTopic());
    }
