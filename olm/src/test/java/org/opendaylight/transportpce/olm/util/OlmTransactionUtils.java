...
public final class OlmTransactionUtils {
    ...
    public static Optional<CurrentPmEntry> getCurrentPmListA() {
        ...
        CurrentPmEntryKey resourceKey = new CurrentPmEntryKey(interfaceIIDA,
        ...
        CurrentPmEntry currentPmEntryA = new CurrentPmEntryBuilder()
                ...
                .build();
        return Optional.of(new CurrentPmEntryBuilder(currentPmEntryA).build());
    }

    public static Optional<CurrentPmEntry> getCurrentPmListC() {
        ...
        CurrentPmEntryKey resourceKey = new CurrentPmEntryKey(interfaceIIDC,
                org.opendaylight.yang.gen.v1.http.org.openroadm.resource.types.rev181019
                        .ResourceTypeEnum.Interface,"notApplicable");
        InstanceIdentifier<CurrentPmEntry> iidCurrentPmList = InstanceIdentifier.create(CurrentPmList.class)
                .child(CurrentPmEntry.class, resourceKey);
        CurrentPmEntry currentPmEntryC = new CurrentPmEntryBuilder()
                ...
                .setPmResourceInstance(iidCurrentPmList)
                .setPmResourceType(
                    org.opendaylight.yang.gen.v1.http.org.openroadm.resource.types.rev181019.ResourceTypeEnum.Interface)
                .setPmResourceTypeExtension("")
                .setRetrievalTime(new DateAndTime("2018-06-07T13:22:58+00:00"))
                .build();
        return Optional.of(new CurrentPmEntryBuilder(currentPmEntryC).build());
    }
}
