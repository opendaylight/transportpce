...
public final class OlmPowerServiceRpcImplUtil {
    ...
    public static org.opendaylight.yang.gen.v1.http.org.opendaylight.transportpce.portmapping.rev250714.network
        ...
        return new org.opendaylight.yang.gen.v1.http.org.opendaylight.transportpce.portmapping.rev250714.network
                .NodesBuilder()
            .setNodeId(nodeId)
