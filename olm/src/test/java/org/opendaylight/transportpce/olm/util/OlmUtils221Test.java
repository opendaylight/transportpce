...
import org.opendaylight.transportpce.olm.util.rev181019.OlmUtilsTestObjects;
...
public class OlmUtils221Test {
    @Test
    void testPmFetchAll221() {
        //setup
        ...
        CurrentPmEntry cpe = OlmUtilsTestObjects.newCurrentPmEntry(interfaceOId, List.of(cpm1, cpm2, cpm3),
                ResourceTypeEnum.Interface, "test-exstension", "2021-03-15T13:45:32Z");
        ...
        //test
        Map<String, List<GetPmOutput>> result = OlmUtils221.pmFetchAll(input, testMgr);
