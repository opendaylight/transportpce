    ...
    public static boolean setTransponderPower(String nodeId, String interfaceName, BigDecimal txPower,
        ...
        if ((portMap.getSupportedInterfaceCapability().contains(IfOCHOTU4ODU4.VALUE))
            ...
            ochOtsiInterfaceBuilder.addAugmentation(new org.opendaylight.yang
                    ...
                    .setOch(new OchBuilder(ochOtsiInterfaceBuilder.augmentation(org.opendaylight.yang
            ...
            ochOtsiInterfaceBuilder.addAugmentation(new Interface1Builder()
                    .setOtsi(new OtsiBuilder(ochOtsiInterfaceBuilder.augmentation(Interface1.class).getOtsi())
                            .setTransmitPower(new PowerDBm(Decimal64.valueOf(txPower)))
                            .build())
                    .build());
        }
