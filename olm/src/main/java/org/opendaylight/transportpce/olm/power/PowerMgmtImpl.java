...
public class PowerMgmtImpl implements PowerMgmt {
    ...
    private BigDecimal getPowerVal(Map<String, Double> txPowerRangeMap,
            Map<String, Double> rxSRGPowerRangeMap, Integer openroadmVersion, String nodeId) {
        if (txPowerRangeMap == null || rxSRGPowerRangeMap == null) {
            return null;
            // return null here means return false in setPower()
            // empty txPowerRangeMap + null rxSRGPowerRangeMap is no more allowed now
            // it used to be in previous implementations
        }
