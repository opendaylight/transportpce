...
public class OlmPowerServiceRpcImpl {
     ...
     */
    ListenableFuture<RpcResult<GetPmOutput>> getPm(GetPmInput input) {
     ...
     * @return Result of the request
     */
    ListenableFuture<RpcResult<ServicePowerSetupOutput>> servicePowerSetup(
     ...
     * @return Result of the request
     */
    ListenableFuture<RpcResult<ServicePowerTurndownOutput>>
     ...
     * @return Result of the request
     */
    ListenableFuture<RpcResult<CalculateSpanlossBaseOutput>>
    ...
    ListenableFuture<RpcResult<CalculateSpanlossCurrentOutput>> calculateSpanlossCurrent(
    ...
    ListenableFuture<RpcResult<ServicePowerResetOutput>> servicePowerReset(ServicePowerResetInput input) {
