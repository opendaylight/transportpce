...
class CopyFromOpenRoadmTest {

    @Test
    void copyOpenRoadmTopologyToTapi() throws ExecutionException, InterruptedException {
        ...
        CopyFromOpenRoadm copyFromOpenRoadm =
            new CopyFromOpenRoadm(new NetworkTransactionImpl(dataStoreContextUtil.getDataBroker()));
        ...
        copyFromOpenRoadm.copyOpenRoadmTopologyToTapi(topologyUpdateResultBuilder.build());
    }
