        ...
        switch (dsrNodeType) {
            case "switch":
                ...
                Uuid networkNepUuid = new Uuid(
                        ...
                        .toString());
                checkNepNetworkODU4(nep2, networkNepUuid, "XPDR2-NETWORK1", "NodeEdgePoint_N", "SPDR-SA1-XPDR2", DSR);
            ...
            case "mux":
                ...
                Uuid client3NepUuid = new Uuid(
                        ...
                        .toString());
                checkNepClient10G(nep3, client3NepUuid, "XPDR1-CLIENT3", "NodeEdgePoint_C", "SPDR-SA1-XPDR1", DSR);
                ...
                Uuid networkNepUuid2 = new Uuid(
                        ...
                        .toString());
                checkNepNetworkODU4(nep4, networkNepUuid2, "XPDR1-NETWORK1", "NodeEdgePoint_N", "SPDR-SA1-XPDR1", DSR);
            ...
            case "tpdr":
                ...
                Uuid client1NepUuid = new Uuid(
                        ...
                        .toString());
                checkNepClient100GTpdr(nep5, client1NepUuid, "XPDR1-CLIENT1", "100G-tpdr", "XPDR-A1-XPDR1", DSR);

                OwnedNodeEdgePoint nep6 = nepsN.get(0);
                Uuid networkNepUuid3 = new Uuid(
                        UUID.nameUUIDFromBytes((nodeId + "+DSR+XPDR1-NETWORK1").getBytes(Charset.forName("UTF-8")))
                        .toString());
                checkNepNetworkODU4(nep6, networkNepUuid3, "XPDR1-NETWORK1", "NodeEdgePoint_N", "XPDR-A1-XPDR1", DSR);
