...
public class TapiTopologyImplExceptionTest {
    ...
    public void getTopologyDetailsWithExceptionTest() throws InterruptedException, ExecutionException {
        ...
        ListenableFuture<RpcResult<GetTopologyDetailsOutput>> result;
        try {
            result = tapiTopoImpl.getTopologyDetails(input);
        } catch (NullPointerException e) {
            result = null;
        }

        RpcResult<GetTopologyDetailsOutput> rpcResult;
        Topology topology;
        try {
            rpcResult = result.get();
            topology = rpcResult.getResult().getTopology();
        } catch (NullPointerException e) {
            topology = null;
        }
