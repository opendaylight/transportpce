...
/**
 * This Class manages  the conversion of a TAPI topology in Data store to a T-API abstracted Topology to be provided
 * as the output of GetTopologyDetails RPC.
...
public class AbstractTapiTopoToNbi {
    ...
    /**
     * Abstracts the ROADM infrastructure of the topology into a single Node that will have
     * TapiStringConstants.RDM_INFRA Name
     */
    ...
    /**
     * Removes from TapiLinks List all links that do not correspond to XPONDER-to-ROADM links, filtering
     * links on NameKeys
     */
