...
public interface NodeTypeCollection {
     ...
     * @return true if the addition was successful, false otherwise.
     */
    boolean add(Node node, String supportingNodeName, Set<TerminationPoint> terminationPoint);
     ...
     * will always be present in the returned Map.
     *
     * @param openroadmNodeType OpenROADM node types to filter the termination points.
     * @return A list of OpenroadmNodeType one wishes to be returned.
     */
