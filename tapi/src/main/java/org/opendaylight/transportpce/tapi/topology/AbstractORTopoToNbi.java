...
/**
 * This Class manages  the conversion of OpenROADM topology in Data store to a T-API abstracted Topology to be
 * provided as the output of GetTopologyDetails RPC.
...
public class AbstractORTopoToNbi {
     ...
     *        Considered Nodes & links are the ones present in OpenROADM topology.
    ...
    /**
     * Populate tapiLinks with generic links from a Map<String =NodeUid-NepUuid, String = NodeName-NepName>
     * corresponding to the list of photonic nodes.
     */
