...
public class TapiNetworkModelServiceImpl implements TapiNetworkModelService {
    ...
    public TapiNetworkModelServiceImpl(final DataBroker dataBroker, final R2RTapiLinkDiscovery linkDiscovery) {
    ...
    @Override
    public void createTapiNode(String orNodeId, String orNodeVersion, Nodes node) {
