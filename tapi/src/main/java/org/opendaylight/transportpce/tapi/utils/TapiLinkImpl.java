...
public class TapiLinkImpl implements TapiLink {
    ...
    public void createCepForLink(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.network
        ...
        LOG.debug("TAPILINKIMPLLINE368 CepSpec is {}", otsMCmCepSpecA);
        LOG.debug("TAPILINKIMPLLINE369 Cep Node A OTS is {}", cepNodeAots);
    ...
    public void putRdmCepInTopologyContext(String nodeId, String tpId, String qual, org.opendaylight.yang.gen.v1.urn
        ...
        LOG.debug("TAPILINKIMPLLINE577 NEP id before Merge = {}", nepId);
        LOG.debug("TAPILINKIMPLLINE578 NEP NodeId before Merge {} with UUID {}, ROADM-C1+PHOTONIC_MEDIA Uuid is {}",
