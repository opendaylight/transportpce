...
public class TapiLinkImpl implements TapiLink {
    ...
    public void createCepForLink(org.opendaylight.yang.gen.v1.urn.ietf.params.xml.ns.yang.ietf.network
        ...
        LOG.info("LINKIMPL361 OtsMediaConnectionEndSpec for link {} on A end is {}",link.getLinkId(), otsMCmCepSpecA);
        LOG.info("LINKIMPL362 OtsMediaConnectionEndSpec for link {} on Z end is {}}",link.getLinkId(), otsMCCepSpecZ);
    ...
    public void putRdmCepInTopoContextAndAddToCepList(String nodeId, String tpId, String qual,
        ...
        LOG.info("TAPILINKIMPLLINE577 NEP id before Merge = {} with UUID {} ",
            nepId, new Uuid(UUID.nameUUIDFromBytes(nepId.getBytes(StandardCharsets.UTF_8)).toString()));
        LOG.info("TAPILINKIMPLLINE578 the Node {} hosting NEP before Merge has the UUID {}",
...
//        Object cep3 = cep. augmentation(ConnectionEndPoint2.class);
//        org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.connectivity.rev221121.cep.list.ConnectionEndPoint cep2 =
//            new org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.connectivity.rev221121.cep.list
//                    .ConnectionEndPointBuilder(cep)
//                    .addAugmentation(cep.augmentation(ConnectionEndPoint2.class))
//                .build();
        LOG.info("TAPILINKIMPL569, CEP is {}", cep);
//        LOG.info("TAPILINKIMPL569b, CEP2 is {}", cep2);
        this.cepMap.put(uuidMap, cep);
        LOG.info("TAPILINKIMPL570, cepMap is {}", this.cepMap);
