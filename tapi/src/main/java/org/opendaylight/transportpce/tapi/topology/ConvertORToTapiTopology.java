...
public class ConvertORToTapiTopology {
    ...
    public List<AvailablePayloadStructure> createAvailablePayloadStructureForPhtncMedia(Boolean otsiProvisioned,
        ...
        for (SupportedInterfaceCapability sic : sicList) {
            ...
            if (ifCapType.equals("IfOCHOTU4ODU4") || ifCapType.equals("IfOCHOTU4ODU4Regen")
                    || ifCapType.equals("IfOCHOTU4ODU4Uniregen")) {
                aps.add(new AvailablePayloadStructureBuilder()
                    ...
                    .setCapacity(capBd.setValue(Decimal64.valueOf(100.0 * cepInstanceNber, RoundingMode.DOWN)).build())
                    .build());
            } else if (ifCapType.equals("IfOCHOTUCnODUCn") || ifCapType.equals("IfOtsiOtucnOducn")
                    || ifCapType.equals("IfOCHOTUCnODUCnRegen") || ifCapType.equals("IfOCHOTUCnODUCnUniregen")) {
                aps.add(new AvailablePayloadStructureBuilder()
                    ...
                    .setCapacity(capBd.setValue(Decimal64.valueOf(nepRate * 100.0 * cepInstanceNber, RoundingMode.DOWN))
                        .build())
                    .build());
            }
        }
    ...
    public List<SupportedCepLayerProtocolQualifierInstances> createSupportedCepLayerProtocolQualifier(
        ...
        for (SupportedInterfaceCapability sic : sicList) {
            ...
            switch (lpn.getName()) {
                ...
                case "PHOTONIC_MEDIA":
                    if (ifCapType.equals("IfOCHOTU4ODU4") || ifCapType.equals("IfOCHOTU4ODU4Regen")
                            || ifCapType.equals("IfOCHOTU4ODU4Uniregen") || ifCapType.equals("IfOCHOTUCnODUCn")
                            || ifCapType.equals("IfOCHOTUCnODUCnRegen") || ifCapType.equals("IfOCHOTUCnODUCnUniregen")
                            || ifCapType.equals("IfOCH")) {
                        sclpqiList.add(new SupportedCepLayerProtocolQualifierInstancesBuilder()
                    ...
                    if (ifCapType.equals("IfOCHOTUCnODUCn") || ifCapType.equals("IfOCHOTUCnODUCnRegen")
                        || ifCapType.equals("IfOCHOTUCnODUCnUniregen")) {
                        sclpqiList.add(new SupportedCepLayerProtocolQualifierInstancesBuilder()
    ...
    public Map<Double, Double> getXpdrUsedWavelength(TerminationPoint tp) {
        if (tp.augmentation(org.opendaylight.yang.gen.v1.http.org.openroadm.network.topology.rev230526
                .TerminationPoint1.class) == null || tp.augmentation(org.opendaylight.yang.gen.v1.http.org.openroadm
                .network.topology.rev230526.TerminationPoint1.class).getXpdrNetworkAttributes() == null) {
            return null;
        }
    ...
    private OwnedNodeEdgePoint createNep(TerminationPoint oorTp, Map<NameKey, Name> nepNames,
        ...
        if (oorTp.augmentation(TerminationPoint1.class).getTpType().equals(OpenroadmTpType.XPONDERNETWORK)) {
            if (oorTp.augmentation(org.opendaylight.yang.gen.v1.http.org.openroadm.network.topology.rev230526
                .TerminationPoint1.class) == null || oorTp.augmentation(org.opendaylight.yang.gen.v1.http.org.openroadm
                .network.topology.rev230526.TerminationPoint1.class).getXpdrNetworkAttributes() == null) {
