...
package org.opendaylight.transportpce.tapi.sync;
...
public class SyncFromOpenROADM implements Synch {

    private static final Logger LOG = LoggerFactory.getLogger(SyncFromOpenROADM.class);
    ...
    @Override
    public boolean copyOpenRoadmServiceToTapi(String openRoadmServiceName) {
        ...
        LOG.error("Copy OpenROADM service to TAPI failed!");
        return false;
    }
