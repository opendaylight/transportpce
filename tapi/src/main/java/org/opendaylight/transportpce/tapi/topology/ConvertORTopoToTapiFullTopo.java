...
//import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.common.rev221121.PortDirection;
...
//import org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.common.rev221121.SupportedLayerProtocolQualifier;
...
//TODO: remove following lines : no more creation of separated nodes for DSR/ODU and OTSI, no transitional links in 2.4
        // node creation [otsi]
...
//
//        // transitional link creation between network nep of DSR/ODU node and iNep of otsi node
...
//            .setTerminationState(TerminationState.TERMINATEDBIDIRECTIONAL);
    ...
    private Map<OwnedNodeEdgePointKey, OwnedNodeEdgePoint> populateNepsForRdmNode(List<TerminationPoint> tpList,
        ...
        for (TerminationPoint tp:tpList) {
            ...
            if (TapiStringConstants.PHTNC_MEDIA_OMS.equals(nepPhotonicSublayer)) {
...
//            onepMap.put(onep2.key(), onep2);
    ...
    private ServiceInterfacePoint createSIP(Uuid sipUuid, LayerProtocolName layerProtocol, TerminationPoint tp,
        ...
        return new ServiceInterfacePointBuilder()
            ...
            .setSupportedCepLayerProtocolQualifierInstances(createSipSupportedLayerProtocolQualifier(tp,
                layerProtocol))
            .build();
    }

    private List<org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.common.rev221121.service
            ._interface.point.SupportedCepLayerProtocolQualifierInstances>
            createSipSupportedLayerProtocolQualifier(TerminationPoint tp,
            LayerProtocolName lpn) {
        List<org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.common.rev221121.service
            ._interface.point.SupportedCepLayerProtocolQualifierInstances> sclpqiList = new ArrayList<>();
        sclpqiList.add(new org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.common.rev221121.service
                ._interface.point.SupportedCepLayerProtocolQualifierInstancesBuilder()
            .setLayerProtocolQualifier(PHOTONICLAYERQUALIFIEROMS.VALUE)
            .setNumberOfCepInstances(Uint64.valueOf(1))
            .build());
