...
public final class ConnectivityUtils {
    ...
    private Map<ConnectionKey,Connection> createXpdrCepsAndConnectionsDsr(
        ...
        updateXpdrNepPayloadStructure(spcXpdr1, TapiStringConstants.DSR, rate);
        updateXpdrNepPayloadStructure(spcXpdr2, TapiStringConstants.DSR, rate);
        updateXpdrNepPayloadStructure(spcXpdr1, TapiStringConstants.E_ODU, rate);
        updateXpdrNepPayloadStructure(spcXpdr2, TapiStringConstants.E_ODU, rate);
