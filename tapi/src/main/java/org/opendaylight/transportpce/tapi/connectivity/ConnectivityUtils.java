...
public final class ConnectivityUtils {
    ...
    public ServiceCreateInput createORServiceInput(CreateConnectivityServiceInput input, Uuid serviceUuid) {
        ...
        LOG.info("Node a = {}", nodeAid);
        LOG.info("Node z = {}", nodeZid);
        switch (constraint.getServiceLayer().getIntValue()) {
            ...
            case 3:
                ...
                LOG.info("Node a photonic = {}", nodeAid);
                LOG.info("Node z photonic = {}", nodeZid);
                break;
            default:
    ...
    private ServiceZEnd tapiEndPointToServiceZPoint(
        ...
        if (node == null) {
            LOG.info("Node not found in datastore");
            return null;
        }
        ...
        if (nep == null) {
            LOG.info("Nep not found in datastore");
            return null;
        }
