            ...
            switch (serviceFormat) {
                case ODU:
                    ...
                    sipUuid = new Uuid(UUID.nameUUIDFromBytes((String.join("+", "SIP", tp.getTpNodeId(),
                            TapiStringConstants.I_ODU, tp.getTpId())).getBytes(Charset.forName("UTF-8"))).toString());
                ...
                case OTU:
                    ...
                    sipUuid = new Uuid(UUID.nameUUIDFromBytes((String.join("+", "SIP", tp.getTpNodeId(),
                            TapiStringConstants.I_OTSI, tp.getTpId())).getBytes(Charset.forName("UTF-8"))).toString());
                ...
                case Ethernet:
                    ...
                    sipUuid = new Uuid(UUID.nameUUIDFromBytes((String.join("+", "SIP", tp.getTpNodeId(),
                            TapiStringConstants.DSR, tp.getTpId())).getBytes(Charset.forName("UTF-8"))).toString());
