...
public final class TopologyUtils {
    ...
    public Network readTopology(InstanceIdentifier<Network> networkIID)
    ...
    public org.opendaylight.yang.gen.v1.urn.onf.otcc.yang.tapi.topology.rev181210.topology.Node
    ...
    public boolean checkTp(String nodeIdTopo, String nodeIdPortMap, TerminationPoint tp, List<Link> xpdOut, List<
            Link> xpdIn) {
        String networkLcp;
