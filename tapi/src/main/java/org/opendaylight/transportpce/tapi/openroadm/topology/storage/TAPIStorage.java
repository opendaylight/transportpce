...
public class TAPIStorage implements TAPI {

    private static final Logger LOG = LoggerFactory.getLogger(TAPIStorage.class);

    private final NetworkTransactionService networkTransactionService;

    public TAPIStorage(NetworkTransactionService networkTransactionService) {
    ...
    @Override
    public boolean updateTopology(TopologyKey topologyKey, NodeKey nodeKey, Map<OwnedNodeEdgePointKey,
