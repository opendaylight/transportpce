...
/**
 * Default {@link LinkIdFormatter} that concatenates the source and destination node and
 * termination point identifiers, e.g. {@code srcNode-srcTptoDestNode-destTp}.
 */
public class DefaultLinkIdFormatter implements LinkIdFormatter {
