...
def start_tpce():
    if "USE_LIGHTY" in os.environ and os.environ['USE_LIGHTY'] == 'True':
        ...
        executable = os.path.join(os.path.dirname(os.path.realpath(__file__)),"..","..","..","lighty",
            "target","lighty-transportpce-12.0.0-SNAPSHOT","clean-start-controller.sh")
        ...
        executable = os.path.join(os.path.dirname(os.path.realpath(__file__)),"..","..","..","karaf",
