    ...
    def test_04_xpdr_portmapping(self):
        ...
        self.assertIn(
            {'logical-connection-point': 'XPDR1-NETWORK1', 'port-direction': 'bidirectional',
             'xpdr-type': 'tpdr', 'supporting-port': '1', 'connection-map-lcp': 'XPDR1-CLIENT1',
             'port-oper-state': 'InService', 'rate': '0', 'port-admin-state': 'InService',
             'lcp-hash-val': 'OSvMgUyP+mE=', 'supporting-circuit-pack-name': '1/0/1-PLUG-NET',
             'port-qual': 'xpdr-network'}, 
            response['nodes'][0]['mapping'])
        self.assertIn(
            {'logical-connection-point': 'XPDR1-CLIENT1', 'port-direction': 'bidirectional',
             'xpdr-type': 'tpdr', 'supporting-port': 'C1', 'connection-map-lcp': 'XPDR1-NETWORK1',
             'port-oper-state': 'InService', 'rate': '0', 'port-admin-state': 'InService',
             'lcp-hash-val': 'AO9UFkY/TLYw', 'supporting-circuit-pack-name': '1/0/C1-PLUG-CLIENT',
