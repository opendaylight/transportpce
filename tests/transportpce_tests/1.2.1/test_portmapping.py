    ...
    def test_10_xpdr_portmapping_NETWORK1(self):
        ...
        self.assertIn(
            {'supporting-port': '1', 'supporting-circuit-pack-name': '1/0/1-PLUG-NET',
             ...
             'connection-map-lcp': 'XPDR1-CLIENT1', 'port-qual': 'xpdr-network', 'xponder-type': 'tpdr'},
            res['mapping'])
    ...
    def test_11_xpdr_portmapping_NETWORK2(self):
        ...
        self.assertIn(
            {'supporting-port': '1', 'supporting-circuit-pack-name': '1/0/2-PLUG-NET',
             ...
             'connection-map-lcp': 'XPDR1-CLIENT3', 'port-qual': 'xpdr-network', 'xponder-type': 'tpdr'},
            res['mapping'])
    ...
    def test_13_xpdr_portmapping_CLIENT2(self):
        ...
        self.assertIn(
            {'supporting-port': 'C2',
             ...
             'port-qual': 'xpdr-client', 'xponder-type': 'tpdr'},
            res['mapping'])
