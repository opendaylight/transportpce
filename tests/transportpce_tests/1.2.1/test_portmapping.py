    ...
    def test_14_xpdr_portmapping_CLIENT3(self):
        ...
        self.assertIn(
            {'supporting-port': 'C3',
             ...
             'port-qual': 'xpdr-client', 'lcp-hash-val': '791895061'},
            res['mapping'])
    ...
    def test_15_xpdr_portmapping_CLIENT4(self):
        ...
        self.assertIn(
            {'supporting-port': 'C4',
             ...
             'port-qual': 'xpdr-client', 'lcp-hash-val': '791895062'},
            res['mapping'])
