    ...
    def test_11_xpdr_portmapping_NETWORK2(self):
        ...
        self.assertIn(
            {'supporting-port': '1', 'supporting-circuit-pack-name': '1/0/2-PLUG-NET',
             ...
             'connection-map-lcp': 'XPDR1-CLIENT3', 'port-qual': 'xpdr-network', 'lcp-hash-val': '-2126208574'},
            res['mapping'])
    ...
    def test_13_xpdr_portmapping_CLIENT2(self):
        ...
        self.assertIn(
            {'supporting-port': 'C2',
             ...
             'port-qual': 'xpdr-client', 'lcp-hash-val': '2135103529'},
            res['mapping'])
    ...
    def test_14_xpdr_portmapping_CLIENT3(self):
        ...
        self.assertIn(
            {'supporting-port': 'C3',
             ...
             'port-qual': 'xpdr-client' , 'lcp-hash-val': '2135103530'},
            res['mapping'])
    ...
    def test_15_xpdr_portmapping_CLIENT4(self):
        ...
        self.assertIn(
            {'supporting-port': 'C4',
             ...
             'port-qual': 'xpdr-client' , 'lcp-hash-val': '2135103531'},
            res['mapping'])
