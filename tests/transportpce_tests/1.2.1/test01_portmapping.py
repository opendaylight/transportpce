...
class TransportPCEPortMappingTesting(unittest.TestCase):
    ...
    def test_03_rdm_portmapping_info(self):
        response = test_utils_rfc8040.get_portmapping_node_node_info("ROADMA01")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertEqual(
            {'node-type': 'rdm',
    ...
    def test_04_rdm_portmapping_DEG1_TTP_TXRX(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("ROADMA01", "DEG1-TTP-TXRX")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_05_rdm_portmapping_SRG1_PP7_TXRX(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("ROADMA01", "SRG1-PP7-TXRX")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_06_rdm_portmapping_SRG3_PP1_TXRX(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("ROADMA01", "SRG3-PP1-TXRX")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_09_xpdr_portmapping_info(self):
        response = test_utils_rfc8040.get_portmapping_node_node_info("XPDRA01")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertEqual(
            {'node-type': 'xpdr',
    ...
    def test_10_xpdr_portmapping_NETWORK1(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("XPDRA01", "XPDR1-NETWORK1")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_11_xpdr_portmapping_NETWORK2(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("XPDRA01", "XPDR1-NETWORK2")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_12_xpdr_portmapping_CLIENT1(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("XPDRA01", "XPDR1-CLIENT1")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
            {'supporting-port': 'C1',
    ...
    def test_13_xpdr_portmapping_CLIENT2(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("XPDRA01", "XPDR1-CLIENT2")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
            {'supporting-port': 'C2',
    ...
    def test_14_xpdr_portmapping_CLIENT3(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("XPDRA01", "XPDR1-CLIENT3")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_15_xpdr_portmapping_CLIENT4(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("XPDRA01", "XPDR1-CLIENT4")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
