...
class TransportPCEPortMappingTesting(unittest.TestCase):
    ...
    def test_02_rdm_device_connected(self):
        ...
        res = response.json()
        self.assertEqual(
            res['network-topology:node'][0]['netconf-node-topology:connection-status'],
            'connected')
        time.sleep(10)
    ...
    def test_03_rdm_portmapping_info(self):
        ...
        res = response.json()
        self.assertEqual(
            {u'transportpce-portmapping:node-info': {u'node-type': u'rdm',
    ...
    def test_04_rdm_portmapping_DEG1_TTP_TXRX(self):
        ...
        self.assertIn(
            ...
            res['transportpce-portmapping:mapping'])
    ...
    def test_09_xpdr_portmapping_info(self):
        ...
        res = response.json()
        self.assertEqual(
            {u'transportpce-portmapping:node-info': {u'node-type': u'xpdr',
