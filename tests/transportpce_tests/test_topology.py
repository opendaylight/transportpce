        ...
        if os.path.isfile(executable):
            with open('honeynode1.log', 'w') as outfile:
                cls.honeynode_process1 = subprocess.Popen(
                    [executable, "17830", "sample_configs/ord_2.1/oper-XPDRA.xml"],
                    stdout=outfile)
        ...
        if os.path.isfile(executable):
            with open('honeynode2.log', 'w') as outfile:
                cls.honeynode_process2 = subprocess.Popen(
                    [executable, "17831", "sample_configs/ord_2.1/oper-ROADMA.xml"],
                    stdout=outfile)
        ...
        if os.path.isfile(executable):
            with open('honeynode3.log', 'w') as outfile:
                cls.honeynode_process3 = subprocess.Popen(
                    [executable, "17832", "sample_configs/ord_2.1/oper-ROADMB.xml"],
                    stdout=outfile)
        ...
        if os.path.isfile(executable):
            with open('honeynode4.log', 'w') as outfile:
                cls.honeynode_process4 = subprocess.Popen(
                    [executable, "17833", "sample_configs/ord_2.1/oper-ROADMC.xml"],
                    stdout=outfile)
