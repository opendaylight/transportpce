...
# test service-create for OCH-OTU4 service from spdr to spdr
    ...
    def test_19_check_openroadm_topo_spdra(self):
        response = test_utils_rfc8040.get_ietf_network_request('openroadm-topology', 'SPDR-SA1-XPDR1', 'config')
        self.assertEqual(response['status_code'], requests.codes.ok)
    ...
    def test_20_check_openroadm_topo_ROADMA_SRG(self):
        response = test_utils_rfc8040.get_ietf_network_request('openroadm-topology', 'ROADM-A1-SRG1', 'config')
        self.assertEqual(response['status_code'], requests.codes.ok)
    ...
    def test_21_check_openroadm_topo_ROADMA_DEG(self):
        response = test_utils_rfc8040.get_ietf_network_request('openroadm-topology', 'ROADM-A1-DEG2', 'config')
        self.assertEqual(response['status_code'], requests.codes.ok)
        freq_map = base64.b64decode(
