    ...
    def test_11_xpdr_portmapping_NETWORK1(self):
        ...
        self.assertIn(
            {'supported-interface-capability': ['org-openroadm-port-types:if-OCH'],
             ...
             'port-direction': 'bidirectional', 'connection-map-lcp': 'XPDR1-CLIENT1', 'xponder-type': 'tpdr'},
            res['mapping'])
    ...
    def test_12_xpdr_portmapping_NETWORK2(self):
        ...
        self.assertIn(
            {'supported-interface-capability': ['org-openroadm-port-types:if-OCH'],
             ...
             'connection-map-lcp': 'XPDR1-CLIENT2', 'port-qual': 'xpdr-network', 'xponder-type': 'tpdr'},
            res['mapping'])
    ...
    def test_14_xpdr_portmapping_CLIENT2(self):
        ...
        self.assertIn(
            {'supported-interface-capability': ['org-openroadm-port-types:if-100GE'],
             ...
             'connection-map-lcp': 'XPDR1-NETWORK2', 'port-qual': 'xpdr-client', 'xponder-type': 'tpdr'},
            res['mapping'])
