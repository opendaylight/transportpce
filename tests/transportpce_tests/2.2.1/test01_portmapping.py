...
class TransportPCEPortMappingTesting(unittest.TestCase):
    ...
    def test_03_rdm_portmapping_info(self):
        response = test_utils_rfc8040.get_portmapping_node_node_info("ROADM-A1")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertEqual(
            {'node-type': 'rdm',
    ...
    def test_04_rdm_portmapping_DEG1_TTP_TXRX(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("ROADM-A1", "DEG1-TTP-TXRX")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_05_rdm_portmapping_DEG2_TTP_TXRX_with_ots_oms(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("ROADM-A1", "DEG2-TTP-TXRX")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_06_rdm_portmapping_SRG1_PP3_TXRX(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("ROADM-A1", "SRG1-PP3-TXRX")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_07_rdm_portmapping_SRG3_PP1_TXRX(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("ROADM-A1", "SRG3-PP1-TXRX")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_10_xpdr_portmapping_info(self):
        response = test_utils_rfc8040.get_portmapping_node_node_info("XPDR-A1")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertEqual(
            {'node-type': 'xpdr',
    ...
    def test_11_xpdr_portmapping_NETWORK1(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("XPDR-A1", "XPDR1-NETWORK1")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_12_xpdr_portmapping_XPDR2_NETWORK1(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("XPDR-A1", "XPDR1-NETWORK2")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
            {'supported-interface-capability': ['org-openroadm-port-types:if-OCH'],
    ...
    def test_13_xpdr_portmapping_XPDR1_CLIENT1(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("XPDR-A1", "XPDR1-CLIENT1")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_14_xpdr_portmapping_XPDR1_CLIENT2(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("XPDR-A1", "XPDR1-CLIENT2")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
            {'supported-interface-capability': ['org-openroadm-port-types:if-100GE'],
             'supporting-port': 'C1',
    ...
    def test_17_spdr_portmapping_info(self):
        response = test_utils_rfc8040.get_portmapping_node_node_info("SPDR-SA1")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertEqual(
            {'node-type': 'xpdr',
             'node-ip-address': '1.2.3.4',
    ...
    def test_18_spdr_switching_pool_1(self):
        response = test_utils_rfc8040.get_portmapping_node_switching_pool("SPDR-SA1", "1")
        self.assertEqual(response['status_code'], requests.codes.ok)
    ...
    def test_19_spdr_switching_pool_2(self):
        response = test_utils_rfc8040.get_portmapping_node_switching_pool("SPDR-SA1", "2")
        self.assertEqual(response['status_code'], requests.codes.ok)
    ...
    def test_20_spdr_switching_pool_3(self):
        response = test_utils_rfc8040.get_portmapping_node_switching_pool("SPDR-SA1", "3")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertEqual("blocking",
                         response['switching_pool'][0]['switching-pool-type'])
        self.assertEqual(4,
    ...
    def test_21_spdr_portmapping_mappings(self):
        response = test_utils_rfc8040.get_portmapping_node("SPDR-SA1")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertEqual(18, len(response['nodes'][0]['mapping']))

    def test_22_spdr_portmapping_XPDR1_CLIENT1(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("SPDR-SA1", "XPDR1-CLIENT1")
        self.assertEqual(response['status_code'], requests.codes.ok)
    ...
    def test_23_spdr_portmapping_XPDR1_NETWORK1(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("SPDR-SA1", "XPDR1-NETWORK1")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_24_spdr_portmapping_XPDR2_CLIENT2(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("SPDR-SA1", "XPDR2-CLIENT2")
        self.assertEqual(response['status_code'], requests.codes.ok)
        expected_subset_response = {
    ...
    def test_25_spdr_portmapping_XPDR2_NETWORK2(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("SPDR-SA1", "XPDR2-NETWORK2")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_26_spdr_portmapping_XPDR3_CLIENT3(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("SPDR-SA1", "XPDR3-CLIENT3")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_27_spdr_portmapping_XPDR3_NETWORK1(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("SPDR-SA1", "XPDR3-NETWORK1")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
