...
class TransportPCEtesting(unittest.TestCase):
    ...
    def test_12_create_other_service(self):
        response = test_utils.transportpce_api_rpc_request(
    ...
    def test_13_get_other_service1(self):
    ...
    def test_14_check_interface_roadma1_deg2_mc(self):
    ...
    def test_15_check_interface_roadm_a1_deg2_nmc(self):
        response = test_utils.check_node_attribute_request(
    ...
    def test_16_check_interface_roadm_a1_srg3_nmc(self):
        response = test_utils.check_node_attribute_request(
    ...
    def test_17_check_interface_roadm_c1_deg1_mc(self):
        response = test_utils.check_node_attribute_request(
    ...
    def test_18_check_interface_roadm_c1_deg1_nmc(self):
        response = test_utils.check_node_attribute_request(
    ...
    def test_19_check_interface_roadm_c1_srg1_nmc(self):
        response = test_utils.check_node_attribute_request(
    ...
    def test_20_check_openroadm_topo_ROADM_A1_SRG(self):
    ...
    def test_21_check_openroadm_topo_ROADM_A1_DEG(self):
    ...
    def test_22_check_openroadm_topo_ROADM_C1_DEG1(self):
    ...
    def test_23_check_openroadm_topo_ROADM_C1_SRG1(self):
    ...
    def test_24_check_openroadm_topology_links(self):
    ...
    def test_25_delete_openroadm_service(self):
    ...
    def test_26_get_no_service(self):
        response = test_utils.get_ordm_serv_list_request()
        self.assertEqual(response['status_code'], requests.codes.conflict)

    def test_27_check_no_interface_roadm_a1_deg2_mc(self):
        response = test_utils.check_node_attribute_request(
            'ROADM-A1', 'interface', 'DEG2-TTP-TXRX-mc-282:287')
        self.assertEqual(response['status_code'], requests.codes.conflict)

    def test_28_check_no_interface_roadm_a1_deg2_nmc(self):
        response = test_utils.check_node_attribute_request(
            'ROADM-A1', 'interface', 'DEG2-TTP-TXRX-nmc-282:287')
        self.assertEqual(response['status_code'], requests.codes.conflict)

    def test_29_check_no_interface_roadm_a1_srg3_nmc(self):
        response = test_utils.check_node_attribute_request(
            'ROADM-A1', 'interface', 'SRG3-PP1-TXRX-nmc-282:287')
        self.assertEqual(response['status_code'], requests.codes.conflict)

    def test_30_check_no_interface_roadm_c1_deg1_mc(self):
        response = test_utils.check_node_attribute_request(
            'ROADM-C1', 'interface', 'DEG1-TTP-TXRX-mc-282:287')
        self.assertEqual(response['status_code'], requests.codes.conflict)

    def test_31_check_no_interface_roadm_c1_deg1_nmc(self):
        response = test_utils.check_node_attribute_request(
            'ROADM-C1', 'interface', 'DEG1-TTP-TXRX-nmc-282:287')
        self.assertEqual(response['status_code'], requests.codes.conflict)

    def test_32_check_no_interface_roadm_c1_srg1_nmc(self):
        response = test_utils.check_node_attribute_request(
            'ROADM-C1', 'interface', 'SRG1-PP1-TXRX-nmc-282:287')
        self.assertEqual(response['status_code'], requests.codes.conflict)
    ...
    def test_34_check_openroadm_topo_ROADMA_DEG(self):
        response = test_utils.get_ietf_network_node_request('openroadm-topology', 'ROADM-A1-DEG2', 'config')
        self.assertEqual(response['status_code'], requests.codes.ok)
        freq_map = base64.b64decode(
            response['node']['org-openroadm-network-topology:degree-attributes']['avail-freq-maps'][0]['freq-map'])
    ...
    def test_35_check_openroadm_topo_ROADM_C1_DEG1(self):
        response = test_utils.get_ietf_network_node_request('openroadm-topology', 'ROADM-C1-DEG1', 'config')
        self.assertEqual(response['status_code'], requests.codes.ok)
        freq_map = base64.b64decode(
            response['node']['org-openroadm-network-topology:degree-attributes']['avail-freq-maps'][0]['freq-map'])
    ...
    def test_36_check_openroadm_topo_ROADM_C1_SRG1(self):
        response = test_utils.get_ietf_network_node_request('openroadm-topology', 'ROADM-C1-SRG1', 'config')
        self.assertEqual(response['status_code'], requests.codes.ok)
        freq_map = base64.b64decode(
            response['node']['org-openroadm-network-topology:srg-attributes']['avail-freq-maps'][0]['freq-map'])
    ...
    def test_37_getLinks_OtnTopology(self):
        #response = test_utils.get_ietf_network_request('otn-topology', 'config')
        response = test_utils.get_ietf_network_request('openroadm-topology', 'config')
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertEqual(len(response['network'][0]['node']), 13)

    def test_38_check_openroadm_topo_spdra(self):
    ...
    def test_39_check_openroadm_topology(self):
        response = test_utils.get_ietf_network_request('openroadm-topology', 'config')
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertEqual(22,
    ...
    def test_40_disconnect_spdrA(self):
        response = test_utils.unmount_device("SPDR-SA1")
        self.assertIn(response.status_code, (requests.codes.ok, requests.codes.no_content))

    def test_41_disconnect_spdrC(self):
        response = test_utils.unmount_device("SPDR-SC1")
        self.assertIn(response.status_code, (requests.codes.ok, requests.codes.no_content))

    def test_42_disconnect_roadmA(self):
