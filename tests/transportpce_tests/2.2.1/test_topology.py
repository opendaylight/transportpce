...
#END_IGNORE_XTESTING
    ...
    def test_14_omsAttributes_ROADMA_ROADMC(self):
        ...
        url = ("{}/config/ietf-network:networks/network/openroadm-topology/ietf-network-topology:"
               "link/ROADM-A1-DEG1-DEG1-TTP-TXRXtoROADM-C1-DEG2-DEG2-TTP-TXRX/org-openroadm-network-topology:"
               "OMS-attributes/span"
               .format(self.restconf_baseurl))
        data = {"span": {
            "auto-spanloss": "true",
    ...
    def test_15_omsAttributes_ROADMC_ROADMA(self):
        ...
        url = ("{}/config/ietf-network:networks/network/openroadm-topology/ietf-network-topology:"
               "link/ROADM-C1-DEG2-DEG2-TTP-TXRXtoROADM-A1-DEG1-DEG1-TTP-TXRX/org-openroadm-network-topology:"
               "OMS-attributes/span"
               .format(self.restconf_baseurl))
        data = {"span": {
            "auto-spanloss": "true",
    ...
    def test_19_getLinkOmsAttributesOpenRoadmTopology(self):
        ...
        nbLink=len(res['network'][0]['ietf-network-topology:link'])
        self.assertEqual(nbLink,20)
        R2RLink=['ROADM-A1-DEG1-DEG1-TTP-TXRXtoROADM-C1-DEG2-DEG2-TTP-TXRX',
                 'ROADM-C1-DEG2-DEG2-TTP-TXRXtoROADM-A1-DEG1-DEG1-TTP-TXRX']
        for i in range(0,nbLink):
            nodeType = res['network'][0]['ietf-network-topology:link'][i]['org-openroadm-common-network:link-type']
    ...
    def test_22_omsAttributes_ROADMA_ROADMB(self):
        ...
        url = ("{}/config/ietf-network:networks/network/openroadm-topology/ietf-network-topology:"
               "link/ROADM-A1-DEG2-DEG2-TTP-TXRXtoROADM-B1-DEG1-DEG1-TTP-TXRX/org-openroadm-network-topology:"
               "OMS-attributes/span"
               .format(self.restconf_baseurl))
        data = {"span": {
                "auto-spanloss": "true",
    ...
    def test_23_omsAttributes_ROADMB_ROADMA(self):
        ...
        url = ("{}/config/ietf-network:networks/network/openroadm-topology/ietf-network-topology:"
               "link/ROADM-B1-DEG1-DEG1-TTP-TXRXtoROADM-A1-DEG2-DEG2-TTP-TXRX/org-openroadm-network-topology:"
               "OMS-attributes/span"
               .format(self.restconf_baseurl))
        data = {"span": {
                "auto-spanloss": "true",
    ...
    def test_24_omsAttributes_ROADMB_ROADMC(self):
        ...
        url = ("{}/config/ietf-network:networks/network/openroadm-topology/ietf-network-topology:"
               "link/ROADM-B1-DEG2-DEG2-TTP-TXRXtoROADM-C1-DEG1-DEG1-TTP-TXRX/org-openroadm-network-topology:"
               "OMS-attributes/span"
               .format(self.restconf_baseurl))
        data = {"span": {
                "auto-spanloss": "true",
    ...
    def test_25_omsAttributes_ROADMC_ROADMB(self):
        ...
        url = ("{}/config/ietf-network:networks/network/openroadm-topology/ietf-network-topology:"
               "link/ROADM-C1-DEG1-DEG1-TTP-TXRXtoROADM-B1-DEG2-DEG2-TTP-TXRX/org-openroadm-network-topology:"
               "OMS-attributes/span"
               .format(self.restconf_baseurl))
        data = {"span": {
                "auto-spanloss": "true",
    ...
    def test_29_getLinkOmsAttributesOpenRoadmTopology(self):
        ...
        R2RLink = ['ROADM-A1-DEG1-DEG1-TTP-TXRXtoROADM-C1-DEG2-DEG2-TTP-TXRX',
                       'ROADM-C1-DEG2-DEG2-TTP-TXRXtoROADM-A1-DEG1-DEG1-TTP-TXRX',
                       'ROADM-A1-DEG2-DEG2-TTP-TXRXtoROADM-B1-DEG1-DEG1-TTP-TXRX',
                       'ROADM-C1-DEG1-DEG1-TTP-TXRXtoROADM-B1-DEG2-DEG2-TTP-TXRX',
                       'ROADM-B1-DEG1-DEG1-TTP-TXRXtoROADM-A1-DEG2-DEG2-TTP-TXRX',
                       'ROADM-B1-DEG2-DEG2-TTP-TXRXtoROADM-C1-DEG1-DEG1-TTP-TXRX']
        for i in range(0,nbLink):
            nodeType = res['network'][0]['ietf-network-topology:link'][i]['org-openroadm-common-network:link-type']
            link_id=res['network'][0]['ietf-network-topology:link'][i]['link-id']
            if(link_id in R2RLink):
