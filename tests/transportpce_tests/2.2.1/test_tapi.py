...
class TransportTapitesting(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        if result.returncode != 0:
            ...
            cls.feature_installation_status = result.returncode
        time.sleep(120)
        print("tapi feature installed")
    ...
    def setUp(self):  # instruction executed before each test method
        if self.init_failed:
            self.fail('Feature installation failed '+str(self.feature_installation_status))
