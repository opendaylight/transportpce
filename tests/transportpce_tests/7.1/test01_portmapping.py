...
class TransportPCE400GPortMappingTesting(unittest.TestCase):
    ...
    def test_04_tpdr_portmapping_NETWORK1(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("XPDR-A2", "XPDR1-NETWORK1")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_05_tpdr_portmapping_CLIENT1(self):
        response = test_utils_rfc8040.get_portmapping_node_mapping("XPDR-A2", "XPDR1-CLIENT1")
        self.assertEqual(response['status_code'], requests.codes.ok)
        self.assertIn(
    ...
    def test_07_mpdr_portmapping_CLIENT1(self):
        res = test_utils_rfc8040.get_portmapping_node_mapping("XPDR-A2", "XPDR2-CLIENT1")
    ...
    def test_08_check_mccapprofile(self):
        res = test_utils_rfc8040.get_portmapping_node_mc_capa("XPDR-A2", "XPDR-mcprofile")
        self.assertEqual(res['status_code'], requests.codes.ok)
    ...
    def test_09_mpdr_switching_pool(self):
        response = test_utils_rfc8040.get_portmapping_node_switching_pool("XPDR-A2", "1")
        self.assertEqual(response['status_code'], requests.codes.ok)
