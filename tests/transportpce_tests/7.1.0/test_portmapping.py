...
class TransportPCE400GPortMappingTesting(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.processes = test_utils.start_sims(['xpdra'])
    ...
    def test_05_xpdr_device_disconnection(self):
        response = test_utils.unmount_device("XPDR-A1")
        self.assertEqual(response.status_code, requests.codes.ok, test_utils.CODE_SHOULD_BE_200)

    def test_06_xpdr_device_disconnected(self):
      response = test_utils.get_netconf_oper_request("XPDR-A1")
    ...
    def test_07_xpdr_device_not_connected(self):
