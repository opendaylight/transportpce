...
#         cls.processes = test_utils.start_sims([('oc-mpdra', cls.NODE_VERSION_OC), ('roadma', cls.NODE_VERSION_221),
#         ('roadmc', cls.NODE_VERSION_221), ('oc-mpdrc', cls.NODE_VERSION_OC)])
    ...
    def test_15_check_optical_channel(self):
            ...
            'target-output-power': '0.0'}}, **response['openconfig-terminal-device:optical-channel']),
