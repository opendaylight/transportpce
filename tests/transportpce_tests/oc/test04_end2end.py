...
class TestTransportPCEEndtoend4Nodes(unittest.TestCase):
    ...
    def test_15_check_optical_channel(self):
        nodes = ["OC-MPDRA", "OC-MPDRC"]
        for node in nodes:
            response = test_utils_oc.check_node_attribute2_request(node, "component", "cfp2-opt-1-1",
                                                                   "openconfig-terminal-device:optical-channel")
            self.assertEqual(response['status_code'], requests.codes.ok)
            optchannel = response['openconfig-terminal-device:optical-channel']
            expected_optchannel = {'frequency': '192499999',
                                   'operational-mode': 4308,
                                   'target-output-power': '-1.0'
                                   }
    ...
    def test_16_service_path_create_network_check_optical_port_oc_mpdr(self):
        nodes = ["OC-MPDRA", "OC-MPDRC"]
        for node in nodes:
            response = test_utils_oc.check_node_attribute3_request(node, "component", "line-cfp2-1", "port",
    ...
    def test_17_service_create_och_otu4(self):
        response = test_utils.transportpce_api_rpc_request(
    ...
    def test_18_check_optical_channel(self):
        nodes = ["OC-MPDRA", "OC-MPDRC"]
        for node in nodes:
            response = test_utils_oc.check_node_attribute2_request(node, "component", "cfp2-opt-1-1",
                                                                   "openconfig-terminal-device:optical-channel")
            self.assertEqual(response['status_code'], requests.codes.ok)
            optchannel = response['openconfig-terminal-device:optical-channel']
            expected_optchannel = {'frequency': '196100000',
                                   'operational-mode': 4308,
    ...
    def test_19_get_och_otu4_service(self):
    ...
    def test_20_service_create_openconfig_100g(self):
    ...
    def test_21_get_openconfig_100g_service(self):
        response = test_utils.get_ordm_serv_list_attr_request(
    ...
    def test_22_check_optical_channel_oc_mpdra(self):
        nodes = ["OC-MPDRA", "OC-MPDRC"]
        for node in nodes:
            response = test_utils_oc.check_node_attribute2_request(node, "component", "cfp2-opt-1-1",
                                                                   "openconfig-terminal-device:optical-channel")
    ...
    def test_23_service_path_create_network_check_optical_port_oc_mpdra(self):
        # Test optical port on both OC nodes
        nodes = ["OC-MPDRA", "OC-MPDRC"]
        for node in nodes:
            response = test_utils_oc.check_node_attribute3_request(node, "component", "line-cfp2-1", "port",
                                                                   "openconfig-transport-line-common:optical-port")
    ...
    def test_24_delete_openconfig_100g_service(self):
    ...
    def test_27_disconnect_oc_mpdra(self):
        response = test_utils.unmount_device("OC-MPDRA")
        self.assertIn(response.status_code, (requests.codes.ok, requests.codes.no_content))

    def test_28_disconnect_oc_mpdrc(self):
