...
# test create connectivity service from spdrA to spdrC for Photonic_media
    def test_16_create_connectivity_service_PhotonicMedia(self):
        ...
        self.cr_serv_input_data["end-point"][0]["connection-end-point"][0]["node-edge-point-uuid"]\
            = "21efd6a4-2d81-3cdb-aabb-b983fb61904e"
        self.cr_serv_input_data["end-point"][0]["connection-end-point"][0]["connection-end-point-uuid"]\
            = "d8ef5622-df73-322f-8b62-e51a2ec3f797"
        self.cr_serv_input_data["end-point"][1]["connection-end-point"][0]["node-edge-point-uuid"]\
            = "ff10784b-3da2-3b88-88c3-27abc02b66fe"
        self.cr_serv_input_data["end-point"][1]["connection-end-point"][0]["connection-end-point-uuid"]\
            = "cf91f296-7ce7-3d15-a868-0c65d3f76453"
        response = test_utils.transportpce_api_rpc_request(
...
# test create connectivity service from spdrA to spdrC for odu
    def test_19_create_connectivity_service_ODU(self):
        ...
        self.cr_serv_input_data["end-point"][0]["connection-end-point"][0]["node-edge-point-uuid"]\
            = "72c6b97a-3944-3d88-9882-b7e688bb2772"
        self.cr_serv_input_data["end-point"][0]["connection-end-point"][0]["connection-end-point-uuid"]\
            = "de16e16e-eb69-3819-8f59-4378b12a36ec"
        ...
        self.cr_serv_input_data["end-point"][1]["connection-end-point"][0]["node-edge-point-uuid"]\
            = "99e1461c-4679-3dc5-9f59-b3054dce08a4"
        self.cr_serv_input_data["end-point"][1]["connection-end-point"][0]["connection-end-point-uuid"]\
            = "2a7cd883-4017-3f69-b39a-12b81d57d955"
...
# test create connectivity service from spdrA to spdrC for dsr
    def test_22_create_connectivity_service_DSR(self):
        ...
        self.cr_serv_input_data["end-point"][0]["connection-end-point"][0]["node-edge-point-uuid"]\
            = "c6cd334c-51a1-3995-bed3-5cf2b7445c04"
        self.cr_serv_input_data["end-point"][0]["connection-end-point"][0]["connection-end-point-uuid"]\
            = "12bc1201-bb84-3280-b4bf-df58b3cf057c"
        self.cr_serv_input_data["end-point"][1]["layer-protocol-name"] = "DSR"
        self.cr_serv_input_data["end-point"][1]["service-interface-point"]["service-interface-point-uuid"]\
            = self.sZDSR
        self.cr_serv_input_data["end-point"][1]["connection-end-point"][0]["node-edge-point-uuid"]\
            = "50b7521a-4a38-358f-9846-45c55813416a"
        self.cr_serv_input_data["end-point"][1]["connection-end-point"][0]["connection-end-point-uuid"]\
            = "a7ef6781-c149-394b-b21c-48b324f68c98"
        self.cr_serv_input_data["end-point"][1]["layer-protocol-name"] = "DSR"
