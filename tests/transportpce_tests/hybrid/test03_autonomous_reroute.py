...
class TransportPCEtesting(unittest.TestCase):
    ...
    service_path_service_2_AtoZ = [
        ...
        },
        {
            ...
            "resource": {
                "state": "inService",
                "link-id": "ROADM-C1-SRG1-SRG1-PP2-TXRXtoXPDR-C2-XPDR4-XPDR4-NETWORK1"
            }
        },
        {
            "id": "1",
        ...
        },
        {
            ...
            "resource": {
                "state": "inService",
                "tp-id": "XPDR4-NETWORK1",
                "tp-node-id": "XPDR-A2-XPDR4"
            }
        },
        {
            "id": "0",
        ...
        },
        {
            ...
            "resource": {
                "state": "inService",
                "link-id": "XPDR-A2-XPDR4-XPDR4-NETWORK1toROADM-A1-SRG1-SRG1-PP2-TXRX"
            }
        },
        {
            "id": "4",
    ...
    def test_09_connect_roadmc_PP2_to_xpdrc2_1_N1(self):
    ...
    def test_10_connect_xprda2_4_N1_to_roadma_PP2(self):
        response = test_utils.connect_xpdr_to_rdm_request("XPDR-A2", "4", "1",
    ...
    def test_11_connect_roadma_PP2_to_xpdra2_4_N1(self):
        response = test_utils.connect_rdm_to_xpdr_request("XPDR-A2", "4", "1",
                                                          "ROADM-A1", "1", "SRG1-PP2-TXRX")
        self.assertEqual(response.status_code, requests.codes.ok)
        self.assertIn('Roadm Xponder links created successfully',
                      response.json()["output"]["result"])
    ...
    def test_12_connect_xprdc2_4_N1_to_roadmc_PP2(self):
        response = test_utils.connect_xpdr_to_rdm_request("XPDR-C2", "4", "1",
    ...
    def test_13_connect_roadmc_PP2_to_xpdrc2_1_N1(self):
        response = test_utils.connect_rdm_to_xpdr_request("XPDR-C2", "4", "1",
                                                          "ROADM-C1", "1", "SRG1-PP2-TXRX")
        self.assertEqual(response.status_code, requests.codes.ok)
        self.assertIn('Roadm Xponder links created successfully',
                      response.json()["output"]["result"])
    ...
    def test_28_create_eth_service2_without_service_resiliency(self):
        ...
        self.cr_serv_sample_data["input"]["service-a-end"]["tx-direction"][0]["port"]["port-device-name"] = \
            "XPDR-A2-XPDR4"
        self.cr_serv_sample_data["input"]["service-a-end"]["rx-direction"][0]["port"]["port-device-name"] = \
            "XPDR-A2-XPDR4"
        self.cr_serv_sample_data["input"]["service-z-end"]["tx-direction"][0]["port"]["port-device-name"] = \
            "XPDR-C2-XPDR4"
        self.cr_serv_sample_data["input"]["service-z-end"]["rx-direction"][0]["port"]["port-device-name"] = \
            "XPDR-C2-XPDR4"
