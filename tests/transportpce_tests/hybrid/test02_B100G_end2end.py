...
# test service-create for OCH-OTU4 service from xpdra2 to xpdrc2
    def test_11_check_otn_topology(self):
        ...
        self.assertEqual(nbNode, 4, 'There should be 6 nodes')
    ...
    def test_15_check_interface_OTUC4_xpdra2(self):
        response = test_utils.check_netconf_node_request(
    ...
    def test_16_check_interface_och_xpdrc2(self):
        response = test_utils.check_netconf_node_request(
    ...
    def test_17_check_interface_OTUC4_xpdrc2(self):
        response = test_utils.check_netconf_node_request(
    ...
    def test_18_check_no_interface_ODUC4_xpdra2(self):
        response = test_utils.check_netconf_node_request(
    ...
    def test_19_check_openroadm_topo_xpdra2(self):
    ...
    def test_20_check_otn_topo_OTUC4_links(self):
        response = test_utils.get_otn_topo_request()
        self.assertEqual(response.status_code, requests.codes.ok)
        res = response.json()
...
# test service-create for ODU4 service from xpdra2 to xpdrc2
    def test_21_create_ODUC4_service(self):
    ...
    def test_22_get_ODUC4_service1(self):
        response = test_utils.get_service_list_request(
    ...
    def test_23_check_interface_ODUC4_xpdra2(self):
        response = test_utils.check_netconf_node_request(
            "XPDR-A2", "interface/XPDR2-NETWORK1-ODUC4")
        self.assertEqual(response.status_code, requests.codes.ok)
        res = response.json()
    ...
    def test_24_check_interface_ODUC4_xpdrc2(self):
        response = test_utils.check_netconf_node_request(
    ...
    def test_25_check_otn_topo_links(self):
        response = test_utils.get_otn_topo_request()
        self.assertEqual(response.status_code, requests.codes.ok)
        res = response.json()
        nb_links = len(res['network'][0]['ietf-network-topology:link'])
    ...
    def test_26_check_otn_topo_tp(self):
        response = test_utils.get_otn_topo_request()
        res = response.json()
...
# test service-create for 100GE service from xpdra2 to xpdrc2
    def test_27_create_100GE_service(self):
    ...
    def test_28_get_100GE_service(self):
        response = test_utils.get_service_list_request(
    ...
    def test_29_check_interface_100GE_CLIENT_xpdra2(self):
        response = test_utils.check_netconf_node_request(
    ...
    def test_30_check_interface_ODU4_CLIENT_xpdra2(self):
        response = test_utils.check_netconf_node_request(
    ...
    def test_31_check_interface_ODU4_NETWORK_xpdra2(self):
        response = test_utils.check_netconf_node_request(
    ...
    def test_32_check_ODU4_connection_xpdra2(self):
        response = test_utils.check_netconf_node_request(
            "XPDR-A2",
    ...
    def test_33_check_interface_100GE_CLIENT_xpdrc2(self):
        response = test_utils.check_netconf_node_request(
    ...
    def test_34_check_interface_ODU4_CLIENT_xpdrc2(self):
        response = test_utils.check_netconf_node_request(
    ...
    def test_35_check_interface_ODU4_NETWORK_xpdrc2(self):
        response = test_utils.check_netconf_node_request(
    ...
    def test_36_check_ODU4_connection_xpdrc2(self):
        response = test_utils.check_netconf_node_request(
            "XPDR-C2",
            "odu-connection/XPDR2-CLIENT1-ODU4-service-100GE-x-XPDR2-NETWORK1-ODU4-service-100GE")
        self.assertEqual(response.status_code, requests.codes.ok)
    ...
    def test_37_check_otn_topo_links(self):
        response = test_utils.get_otn_topo_request()
        self.assertEqual(response.status_code, requests.codes.ok)
        res = response.json()
        nb_links = len(res['network'][0]['ietf-network-topology:link'])
    ...
    def test_38_check_otn_topo_tp(self):
        response = test_utils.get_otn_topo_request()
        res = response.json()
        for node in res['network'][0]['node']:
            if node['node-id'] == 'XPDR-A2-XPDR2' or 'XPDR-C2-XPDR2':
    ...
    def test_39_delete_100GE_service(self):
    ...
    def test_40_check_service_list(self):
        response = test_utils.get_service_list_request("")
        self.assertEqual(response.status_code, requests.codes.ok)
        res = response.json()
    ...
    def test_41_check_no_ODU4_connection_xpdra2(self):
    ...
    def test_42_check_no_interface_ODU4_NETWORK_xpdra2(self):
        response = test_utils.check_netconf_node_request(
            "XPDR-A2", "interface/XPDR2-NETWORK1-ODU4-service-100GE")
        self.assertEqual(response.status_code, requests.codes.conflict)

    def test_43_check_no_interface_ODU4_CLIENT_xpdra2(self):
        response = test_utils.check_netconf_node_request(
            "XPDR-A2", "interface/XPDR2-CLIENT1-ODU4-service-100GE")
        self.assertEqual(response.status_code, requests.codes.conflict)

    def test_44_check_no_interface_100GE_CLIENT_xpdra2(self):
        response = test_utils.check_netconf_node_request(
            "XPDR-A2", "interface/XPDR2-CLIENT1-ETHERNET100G")
        self.assertEqual(response.status_code, requests.codes.conflict)

    def test_45_check_otn_topo_links(self):
        response = test_utils.get_otn_topo_request()
        self.assertEqual(response.status_code, requests.codes.ok)
        res = response.json()
        nb_links = len(res['network'][0]['ietf-network-topology:link'])
    ...
    def test_46_check_otn_topo_tp(self):
        response = test_utils.get_otn_topo_request()
        res = response.json()
        for node in res['network'][0]['node']:
            if (node['node-id'] == 'XPDR-A2-XPDR2' or 'XPDR-C2-XPDR2'):
    ...
    def test_47_delete_ODUC4_service(self):
    ...
    def test_49_check_no_interface_ODU4_spdra(self):
        response = test_utils.check_netconf_node_request(
            "XPDR-A2", "interface/XPDR2-NETWORK1-ODUC4")
        self.assertEqual(response.status_code, requests.codes.conflict)

    def test_50_check_otn_topo_links(self):
        self.test_20_check_otn_topo_OTUC4_links()

    def test_51_check_otn_topo_tp(self):
        response = test_utils.get_otn_topo_request()
        res = response.json()
        for node in res['network'][0]['node']:
            if node['node-id'] == 'XPDR-A2-XPDR2' or 'XPDR-C2-XPDR2':
    ...
    def test_52_delete_OTUC4_service(self):
    ...
    def test_53_get_no_service(self):
        response = test_utils.get_service_list_request("")
        self.assertEqual(response.status_code, requests.codes.conflict)
        res = response.json()
        self.assertIn(
    ...
    def test_54_check_no_interface_OTUC4_xpdra2(self):
        response = test_utils.check_netconf_node_request(
            "XPDR-A2", "interface/XPDR2-NETWORK1-OTUC4")
        self.assertEqual(response.status_code, requests.codes.conflict)

    def test_55_check_no_interface_OCH_xpdra2(self):
        response = test_utils.check_netconf_node_request(
            "XPDR-A2", "interface/XPDR2-NETWORK1-755:768")
        self.assertEqual(response.status_code, requests.codes.conflict)

    def test_56_check_no_interface_OTSI_xpdra2(self):
        response = test_utils.check_netconf_node_request(
            "XPDR-A2", "interface/XPDR2-NETWORK1-OTSI-GROUP")
        self.assertEqual(response.status_code, requests.codes.conflict)

    def test_57_getLinks_OtnTopology(self):
        response = test_utils.get_otn_topo_request()
        self.assertEqual(response.status_code, requests.codes.ok)
        res = response.json()
        self.assertNotIn('ietf-network-topology:link', res['network'][0])

    def test_58_check_openroadm_topo_xpdra2(self):
        response = test_utils.get_ordm_topo_request("node/XPDR-A2-XPDR2")
        self.assertEqual(response.status_code, requests.codes.ok)
        res = response.json()
    ...
    def test_59_check_openroadm_topology(self):
    ...
    def test_60_connect_xprda2_2_N1_to_roadma_PP2(self):
    ...
    def test_61_connect_roadma_PP2_to_xpdra2_2_N1(self):
    ...
    def test_62_connect_xprdc2_2_N1_to_roadmc_PP2(self):
    ...
    def test_63_connect_roadmc_PP2_to_xpdrc2_2_N1(self):
...
# test service-create for 400GE service from xpdra2 to xpdrc2
    def test_64_create_400GE_service(self):
    ...
    def test_65_get_400GE_service(self):
        response = test_utils.get_service_list_request(
    ...
    def test_66_check_xc1_roadma(self):
    ...
    def test_67_check_topo_xpdra2(self):
    ...
    def test_68_check_topo_roadma_SRG1(self):
    ...
    def test_69_check_topo_roadma_DEG1(self):
    ...
    def test_70_check_interface_100GE_CLIENT_xpdra2(self):
        response = test_utils.check_netconf_node_request(
    ...
    def test_71_check_interface_OTSI_xpdra2(self):
        response = test_utils.check_netconf_node_request(
    ...
    def test_72_check_interface_OTSI_GROUP_xpdra2(self):
        response = test_utils.check_netconf_node_request(
    ...
    def test_73_check_interface_OTUC4_xpdra2(self):
        response = test_utils.check_netconf_node_request(
    ...
    def test_74_check_interface_ODUC4_xpdra2(self):
        response = test_utils.check_netconf_node_request(
    ...
    def test_75_delete_400GE_service(self):
    ...
    def test_76_get_no_service(self):
        response = test_utils.get_service_list_request("")
        self.assertEqual(response.status_code, requests.codes.conflict)
        res = response.json()
        self.assertIn(
    ...
    def test_77_check_no_interface_ODUC4_xpdra2(self):
        response = test_utils.check_netconf_node_request(
            "XPDR-A2", "interface/XPDR1-NETWORK1-ODUC4")
        self.assertEqual(response.status_code, requests.codes.conflict)

    def test_78_check_no_interface_OTUC4_xpdra2(self):
        response = test_utils.check_netconf_node_request(
            "XPDR-A2", "interface/XPDR1-NETWORK1-OTUC4")
        self.assertEqual(response.status_code, requests.codes.conflict)

    def test_79_check_no_interface_OTSI_GROUP_xpdra2(self):
        response = test_utils.check_netconf_node_request(
            "XPDR-A2", "interface/XPDR1-NETWORK1-OTSI-GROUP")
        self.assertEqual(response.status_code, requests.codes.conflict)

    def test_80_check_no_interface_OTSI_xpdra2(self):
        response = test_utils.check_netconf_node_request(
            "XPDR-A2", "interface/XPDR1-NETWORK1-755:768")
        self.assertEqual(response.status_code, requests.codes.conflict)

    def test_81_check_no_interface_400GE_CLIENT_xpdra2(self):
        response = test_utils.check_netconf_node_request(
            "XPDR-A2", "interface/XPDR1-CLIENT1-ETHERNET")
        self.assertEqual(response.status_code, requests.codes.conflict)

    def test_82_disconnect_xponders_from_roadm(self):
    ...
    def test_83_disconnect_xpdra2(self):
        response = test_utils.unmount_device("XPDR-A2")
        self.assertEqual(response.status_code, requests.codes.ok,
                         test_utils.CODE_SHOULD_BE_200)

    def test_84_disconnect_xpdrc2(self):
        response = test_utils.unmount_device("XPDR-C2")
        self.assertEqual(response.status_code, requests.codes.ok,
                         test_utils.CODE_SHOULD_BE_200)

    def test_85_disconnect_roadmA(self):
        response = test_utils.unmount_device("ROADM-A1")
        self.assertEqual(response.status_code, requests.codes.ok,
                         test_utils.CODE_SHOULD_BE_200)

    def test_86_disconnect_roadmC(self):
