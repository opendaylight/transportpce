...
SIMS = {
    ...
    ('oc200-mpdra', 'oc200'): {'port': '19840', 'configfile': 'sample-openconfig200-mpdr.xml', 'logfile': 'mpdra-oc200.log', 'restconf_baseurl': 'http://127.0.0.1:8159/restconf'},
    ('oc200-mpdrc', 'oc200'): {'port': '19844', 'configfile': 'sample-openconfig200-mpdr.xml', 'logfile': 'mpdrc-oc200.log', 'restconf_baseurl': 'http://127.0.0.1:8160/restconf'}
}
