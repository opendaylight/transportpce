...
SIMS = {
    ...
    ('oc200-mpdr', 'oc200'): {'port': '19841', 'configfile': 'sample-openconfig200-mpdr.xml', 'logfile': 'sample-openconfig200-mpdr.log', 'restconf_baseurl': 'http://127.0.0.1:8161/restconf'},
    ('oc200-mpdr-C', 'oc200'): {'port': '19842', 'configfile': 'sample-openconfig200-mpdr.xml', 'logfile': 'sample-openconfig200-mpdr-C.log', 'restconf_baseurl': 'http://127.0.0.1:8162/restconf'}
}
