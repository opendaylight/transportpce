...
SIMS = {
    ...
    ('oc-mpdra', 'oc'): {'port': '19840', 'configfile': 'sample-openconfig-mpdr.xml', 'logfile':
        'sample-openconfig-mpdra.log', 'restconf_baseurl': 'http://127.0.0.1:8159/restconf'},
    ('oc-mpdrc', 'oc'): {'port': '19844', 'configfile': 'sample-openconfig-mpdr.xml', 'logfile':
        'sample-openconfig-mpdrc.log', 'restconf_baseurl': 'http://127.0.0.1:8160/restconf'}
}
