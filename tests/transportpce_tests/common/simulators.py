...
SIMS = {
    ...
    ('oc200-mpdr', 'oc200'): {'port': '19840', 'configfile': 'sample-openconfig200-mpdr.xml', 'logfile': 'sample-openconfig200-mpdr.log', 'restconf_baseurl': 'http://127.0.0.1:8160/restconf'}
}
