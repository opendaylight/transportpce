...
#download maven image 3.9.13 and install it
wget -nv https://dlcdn.apache.org/maven/maven-3/3.9.13/binaries/apache-maven-3.9.13-bin.tar.gz -P /tmp
sudo mkdir -p /opt
sudo tar xf /tmp/apache-maven-3.9.13-bin.tar.gz -C /opt
