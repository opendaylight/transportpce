...
$usage = "
USAGE: openconfig_hijackproxy.pl [-h|--help] [-p|--port <port_number>] [-v|--verbose] [-C|--capabilities <custom_hello_file.xml>] <[login[:password]@]host[:port]> [login] [password]
...
's@<capability>urn:ietf:params:netconf:capability:exi:1.0</capability>@<capability>urn:ietf:params:confnet:capability:ixe:1.0</capability>@'
);
