...
my %regex_hash = (
    ...
    # this removes proprietary extensions capabilities from hello messages
    '<capability>http:\/\/nokia.com\/[^<]*<\/capability>' =>
      's@<capability>http://nokia.com/[^<]*</capability>@@',
    '<capability>http:\/\/nec.com\/[^<]*<\/capability>' =>
      's@<capability>http://nec.com/[^<]*</capability>@@'
);
...
my %regex_hash2 = (
    ...
    # this removes proprietary extensions capabilities from server XML payload
