...
On a brand new debian 12 system, you can simply run as root.

# apt-get install libnet-openssh-perl libio-pty-perl to install them.

Raw TCP connections tutorial
----------------------------

On OpenDaylight, you can mount directly a raw TCP netconf server w/o any.
...
In a third terminal, you can the mount this device with the following request
...
not support netconf over raw TCP, you can use an openssh server subsystems
